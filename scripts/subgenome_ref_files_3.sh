...
if [ "$ncohorts" == no ]; then
	...
	if [[ "$Get_Chromosome" -gt 2000 ]]; then
		for selchr in $Get_Chromosome; do (
			$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -L $selchr $input -ploidy $ploidy -O ../snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_"${selchr}"_raw.vcf.gz --max-reads-per-alignment-start 0 )&
		...
		wait
		cd ../snpcall
		ls ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_*_raw.vcf.gz | parallel gunzip
		...
		$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta $input -ploidy $ploidy -O ../snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_raw.vcf.gz --max-reads-per-alignment-start 0
	fi
...
if [ "$ncohorts" == no ]; then
	...
	if [[ "$Get_Chromosome" -gt 2000 ]]; then
		...
		wait
		cd ../snpcall
		for selchroms in ${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_*_raw.vcf.gz | parallel gunzip
...
if [ "$ncohorts" != no ]; then
	...
	if ls ../snpcall/*.g.vcf.gz >/dev/null 2>&1; then
		...
		for i in $(ls -S *_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_precall.bam); do (
			$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads"  HaplotypeCaller -R ../refgenomes/panref.fasta -I $i -ploidy $ploidy -O ../snpcall/${i%_precall.bam}.g.vcf.gz -ERC GVCF --max-reads-per-alignment-start 0
	...
	for dir in cohorts*/; do
		...
		Get_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ../../refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -nr | awk '{print $1}' )
		for selchr in $Get_Chromosome; do (
			$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads" CombineGVCFs -R ../../refgenomes/panref.fasta -L $selchr $input -O ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_"${selchr}"_raw.g.vcf.gz
			$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads" GenotypeGVCFs -R ../../refgenomes/panref.fasta -L $selchr -V ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_"${selchr}"_raw.g.vcf.gz -O ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_"${selchr}"_raw.vcf.gz
			rm ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_"${selchr}"_raw.g.vcf.gz ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_"${selchr}"_raw.g.vcf.gz.tbi
		...
		bgzip ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_raw.vcf
		tabix -p vcf ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_raw.vcf.gz
		...
		cd ../
		bgzip ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_raw_${dir%/}.vcf
		tabix -p vcf ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_raw_${dir%/}.vcf.gz
		wait
	done
	wait
...
if [ "$ncohorts" != no ]; then
	...
	for dir in cohorts*/; do
		...
		tabix -p vcf ${pop}_${ref1%.f*}_${ref2%.f*}_${calcploidy}x_raw.vcf
...
if [ "$ncohorts" != no ]; then
	...
	for dir in cohorts*/; do
		...
		for selchr in $Get_Chromosome; do (
			...
			rm ${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_*_raw.g.vcf.gz ${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_*_raw.g.vcf.gz.tbi
...
if [ "$ncohorts" != no ]; then
	...
	for dir in cohorts*/; do
		...
		for selchr in $Get_Chromosome; do (
			...
			rm ${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_*_raw.g.vcf.gz ${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_*_raw.g.vcf.gz.tbi
...
if [ "$ncohorts" != no ]; then
	...
	for dir in cohorts*/; do
		...
		for selchr in $Get_Chromosome; do (
			...
			rm ${pop}_${ref1%.f*}_${ploidy_ref1}x_*_raw.g.vcf.gz ${pop}_${ref1%.f*}_${ploidy_ref1}x_*_raw.g.vcf.gz.tbi
...
if [ "$ncohorts" != no ]; then
	...
	for dir in cohorts*/; do
		...
		for selchr in $Get_Chromosome; do (
			...
			rm ${pop}_${ref2%.f*}_${ploidy_ref2}x_*_raw.g.vcf.gz ${pop}_${ref2%.f*}_${ploidy_ref2}x_*_raw.g.vcf.gz.tbi
...
if [ "$ncohorts" != no ]; then
	...
	for dir in cohorts*/; do
		...
		for selchr in $Get_Chromosome; do (
			...
			rm ${pop}_${ref3%.f*}_${ploidy_ref3}x_*_raw.g.vcf.gz ${pop}_${ref3%.f*}_${ploidy_ref3}x_*_raw.g.vcf.gz.tbi
