...
main () {
  ...
  if [[ $nodes -gt 1 ]]; then
    ...
    while IFS="" read -r i || [ -n "$i" ]; do (
      ...
      $samtools view -F4 <(zcat ./alignment/${i%.f*}_redun_${ref1%.f*}.sam.gz 2> /dev/null) | awk '{print $1}' | awk '{print $3"\t"$4}' | awk '$1 != "*"' > ${i%.f*}_redun_${ref1%.f*}_collapse.txt
      ...
      $samtools view -F4 <(zcat ./alignment/${i%.f*}_redun_${ref2%.f*}.sam.gz 2> /dev/null) | awk '{print $1}' | awk '{print $3"\t"$4}' | awk '$1 != "*"' > ${i%.f*}_redun_${ref2%.f*}_collapse.txt
      ...
      $samtools view -F4 <(zcat ./alignment/${i%.f*}_redun_${ref3%.f*}.sam.gz 2> /dev/null) | awk '{print $1}' | awk '{print $3"\t"$4}' | awk '$1 != "*"' > ${i%.f*}_redun_${ref3%.f*}_collapse.txt
      awk '{print $2}' ${i%.f*}_redun_${ref3%.f*}_collapse.txt | awk '{printf "%d000\n", $1/1000}' | paste - ${i%.f*}_redun_${ref3%.f*}_collapse.txt | awk '{print $1"_"$3}' | \
      awk '{!seen[$0]++}END{for (i in seen) print seen[i]}' | awk '{!seen[$0]++}END{for (i in seen) print i, seen[i]}' > ${projdir}/alignment_summaries/copy_number/${i%.f*}_copy_number_${ref3%.f*}.txt  &&
      rm ${i%.f*}_redun_${ref3%.f*}_collapse.txt
      awk 'NR==FNR{sum+= $2; next;} {printf("%s\t%s\t%3.3f%%\t%3.0f\n",$1,$2,100*$2/sum,100*$2/sum)}' ${projdir}/alignment_summaries/copy_number/${i%.f*}_copy_number_${ref3%.f*}.txt ${projdir}/alignment_summaries/copy_number/${i%.f*}_copy_number_${ref3%.f*}.txt > ${projdir}/alignment_summaries/copy_number/${i%.f*}_plot_${ref3%.f*}.txt &&
      unset IFS; printf "%s\t%s\t%s\t%*s\n" $(sed 's/$/ |/' ${projdir}/alignment_summaries/copy_number/${i%.f*}_plot_${ref3%.f*}.txt) | tr ' ' '|' | sort -T ./tmp/ -k1,1 -n | awk '{gsub(/pe-/,""); print}' >> ${projdir}/alignment_summaries/copy_number/${i%.f*}_copy_number_Read_histogram_${ref3%.f*}.txt &&
      ...
      if test ! -f ${projdir}/preprocess/${i%.f*}_${ref1%.f*}_precall.bam.bai && test ! -f ${projdir}/preprocess/${i%.f*}_${ref2%.f*}_precall.bam.bai && test ! -f ${projdir}/preprocess/${i%.f*}_${ref1%.f*}_${ref2%.f*}_precall.bam.bai; then
...

        {
          ...
          for k in $(awk '{A[$1]++}END{for(i in A)print i}' ${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_uniq.sam); do (
            awk -v n="${k}" '$1 == n{print $0}' ${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_uniq.sam | awk -v n="$k" '{for(i=0;i<n;i++) print}' > ${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_exp_${k}.sam ) &
            if [[ $(jobs -r -p | wc -l) -ge $prepthreads ]]; then
            wait
            fi
          done
          wait
          for catexp in ${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_exp_*.sam; do cat $catexp >> ${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_exp.sam 2> /dev/null && wait; done
          wait
          find . -maxdepth 1 -type f -name "${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_exp_*.sam" | xargs rm 2> /dev/null &&
          awk '{print "seq"NR"_"$0}' ${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_exp.sam | tr -s ' ' | tr ' ' '\t' > ${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}.sam &&
          rm ${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_exp.sam ${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_uniq.sam &&
          wait
        ...
        if [[ "${ploidy_ref1}" && "${ploidy_ref2}" ]]; then
          {
            ...
            for k in $(awk '{A[$1]++}END{for(i in A)print i}' ${i%.f*}_${ref1%.f*}_${ref2%.f*}_uniq.sam); do (
              awk -v n="${k}" '$1 == n{print $0}' ${i%.f*}_${ref1%.f*}_${ref2%.f*}_uniq.sam | awk -v n="$k" '{for(i=0;i<n;i++) print}' > ${i%.f*}_${ref1%.f*}_${ref2%.f*}_exp_${k}.sam ) &
              if [[ $(jobs -r -p | wc -l) -ge $prepthreads ]]; then
              wait
              fi
            done
            wait
            for catexp in ${i%.f*}_${ref1%.f*}_${ref2%.f*}_exp_*.sam; do cat $catexp >> ${i%.f*}_${ref1%.f*}_${ref2%.f*}_exp.sam 2> /dev/null && wait; done
            wait
            find . -maxdepth 1 -type f -name "${i%.f*}_${ref1%.f*}_${ref2%.f*}_exp_*.sam" | xargs rm 2> /dev/null &&
            awk '{print "seq"NR"_"$0}' ${i%.f*}_${ref1%.f*}_${ref2%.f*}_exp.sam | tr -s ' ' | tr ' ' '\t' > ${i%.f*}_${ref1%.f*}_${ref2%.f*}.sam &&
            rm ${i%.f*}_${ref1%.f*}_${ref2%.f*}_exp.sam ${i%.f*}_${ref1%.f*}_${ref2%.f*}_uniq.sam &&
            wait
        ...
        if [[ "${ploidy_ref1}" && "${ploidy_ref3}" ]]; then
          {
            ...
            for k in $(awk '{A[$1]++}END{for(i in A)print i}' ${i%.f*}_${ref1%.f*}_${ref3%.f*}_uniq.sam); do (
              awk -v n="${k}" '$1 == n{print $0}' ${i%.f*}_${ref1%.f*}_${ref3%.f*}_uniq.sam | awk -v n="$k" '{for(i=0;i<n;i++) print}' > ${i%.f*}_${ref1%.f*}_${ref3%.f*}_exp_${k}.sam ) &
              if [[ $(jobs -r -p | wc -l) -ge $prepthreads ]]; then
              wait
              fi
            done
            wait
            for catexp in ${i%.f*}_${ref1%.f*}_${ref3%.f*}_exp_*.sam; do cat $catexp >> ${i%.f*}_${ref1%.f*}_${ref3%.f*}_exp.sam 2> /dev/null && wait; done
            wait
            find . -maxdepth 1 -type f -name "${i%.f*}_${ref1%.f*}_${ref3%.f*}_exp_*.sam" | xargs rm 2> /dev/null &&
            awk '{print "seq"NR"_"$0}' ${i%.f*}_${ref1%.f*}_${ref3%.f*}_exp.sam | tr -s ' ' | tr ' ' '\t' > ${i%.f*}_${ref1%.f*}_${ref3%.f*}.sam &&
            rm ${i%.f*}_${ref1%.f*}_${ref3%.f*}_exp.sam ${i%.f*}_${ref1%.f*}_${ref3%.f*}_uniq.sam &&
            wait
        ...
        if [[ "${ploidy_ref2}" && "${ploidy_ref3}" ]]; then
          {
            ...
            for k in $(awk '{A[$1]++}END{for(i in A)print i}' ${i%.f*}_${ref2%.f*}_${ref3%.f*}_uniq.sam); do (
              awk -v n="${k}" '$1 == n{print $0}' ${i%.f*}_${ref2%.f*}_${ref3%.f*}_uniq.sam | awk -v n="$k" '{for(i=0;i<n;i++) print}' > ${i%.f*}_${ref2%.f*}_${ref3%.f*}_exp_${k}.sam ) &
              if [[ $(jobs -r -p | wc -l) -ge $prepthreads ]]; then
              wait
              fi
            done
            wait
            for catexp in ${i%.f*}_${ref2%.f*}_${ref3%.f*}_exp_*.sam; do cat $catexp >> ${i%.f*}_${ref2%.f*}_${ref3%.f*}_exp.sam 2> /dev/null && wait; done
            wait
            find . -maxdepth 1 -type f -name "${i%.f*}_${ref2%.f*}_${ref3%.f*}_exp_*.sam" | xargs rm 2> /dev/null &&
            awk '{print "seq"NR"_"$0}' ${i%.f*}_${ref2%.f*}_${ref3%.f*}_exp.sam | tr -s ' ' | tr ' ' '\t' > ${i%.f*}_${ref2%.f*}_${ref3%.f*}.sam &&
            rm ${i%.f*}_${ref2%.f*}_${ref3%.f*}_exp.sam ${i%.f*}_${ref2%.f*}_${ref3%.f*}_uniq.sam &&
            wait
        ...
        if [[ "${ploidy_ref1}" ]]; then
          {
            if [[ "$ploidy_ref1" ]]; then
              ...
              for k in $(awk '{A[$1]++}END{for(i in A)print i}' ${i%.f*}_${ref1%.f*}_uniq.sam); do (
                awk -v n="${k}" '$1 == n{print $0}' ${i%.f*}_${ref1%.f*}_uniq.sam | awk -v n="$k" '{for(i=0;i<n;i++) print}' > ${i%.f*}_${ref1%.f*}_exp_${k}.sam ) &
                if [[ $(jobs -r -p | wc -l) -ge $prepthreads ]]; then
                wait
                fi
              done
              wait
              for catexp in ${i%.f*}_${ref1%.f*}_exp_*.sam; do cat $catexp >> ${i%.f*}_${ref1%.f*}_exp.sam 2> /dev/null && wait; done
              wait
              find . -maxdepth 1 -type f -name "${i%.f*}_${ref1%.f*}_exp_*.sam" | xargs rm 2> /dev/null &&
              awk '{print "seq"NR"_"$0}' ${i%.f*}_${ref1%.f*}_exp.sam | tr -s ' ' | tr ' ' '\t' > ${i%.f*}_${ref1%.f*}.sam &&
              rm ${i%.f*}_${ref1%.f*}_exp.sam ${i%.f*}_${ref1%.f*}_uniq.sam &&
              wait
        ...
        if [[ "${ploidy_ref2}" ]]; then
          {
            if [[ "$ploidy_ref2" ]]; then
              ...
              for k in $(awk '{A[$1]++}END{for(i in A)print i}' ${i%.f*}_${ref2%.f*}_uniq.sam); do (
                awk -v n="${k}" '$1 == n{print $0}' ${i%.f*}_${ref2%.f*}_uniq.sam | awk -v n="$k" '{for(i=0;i<n;i++) print}' > ${i%.f*}_${ref2%.f*}_exp_${k}.sam ) &
                if [[ $(jobs -r -p | wc -l) -ge $prepthreads ]]; then
                wait
                fi
              done
              wait
              for catexp in ${i%.f*}_${ref2%.f*}_exp_*.sam; do cat $catexp >> ${i%.f*}_${ref2%.f*}_exp.sam 2> /dev/null && wait; done
              wait
              find . -maxdepth 1 -type f -name "${i%.f*}_${ref2%.f*}_exp_*.sam" | xargs rm 2> /dev/null &&
              awk '{print "seq"NR"_"$0}' ${i%.f*}_${ref2%.f*}_exp.sam | tr -s ' ' | tr ' ' '\t' > ${i%.f*}_${ref2%.f*}.sam &&
              rm ${i%.f*}_${ref2%.f*}_exp.sam ${i%.f*}_${ref2%.f*}_uniq.sam &&
              wait
        ...
        if [[ "${ploidy_ref3}" ]]; then
          {
            if [[ "$ploidy_ref3" ]]; then
              ...
              for k in $(awk '{A[$1]++}END{for(i in A)print i}' ${i%.f*}_${ref3%.f*}_uniq.sam); do (
                awk -v n="${k}" '$1 == n{print $0}' ${i%.f*}_${ref3%.f*}_uniq.sam | awk -v n="$k" '{for(i=0;i<n;i++) print}' > ${i%.f*}_${ref3%.f*}_exp_${k}.sam ) &
                if [[ $(jobs -r -p | wc -l) -ge $prepthreads ]]; then
                wait
                fi
              done
              wait
              for catexp in ${i%.f*}_${ref3%.f*}_exp_*.sam; do cat $catexp >> ${i%.f*}_${ref3%.f*}_exp.sam 2> /dev/null && wait; done
              wait
              find . -maxdepth 1 -type f -name "${i%.f*}_${ref3%.f*}_exp_*.sam" | xargs rm 2> /dev/null &&
              awk '{print "seq"NR"_"$0}' ${i%.f*}_${ref3%.f*}_exp.sam | tr -s ' ' | tr ' ' '\t' > ${i%.f*}_${ref3%.f*}.sam &&
              rm ${i%.f*}_${ref3%.f*}_exp.sam ${i%.f*}_${ref3%.f*}_uniq.sam &&
              wait
  ...
  main () {
    ...
    if [[ $nodes -gt 1 ]]; then
  	...
  	if [[ "$samples_list" == "samples_list_node_1.txt" ]]; then
        ...
        if [[ "$ploidy_ref1" && "$ploidy_ref3" ]]; then
          ...
          if [[ -z "$Get_Chromosome" ]]; then
            ...
            if [[ "$(ls ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref3%.f*}_${ploidy}x_${selchr}_raw.vcf* 2> /dev/null | wc -l)" -eq 0 ]]; then
              echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ${projdir}/refgenomes/${ref1%.f*}.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2":1-"$3}' > ${projdir}/refgenomes/${ref1%.f*}.list
              $GATK --java-options "$Xmx2 -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" HaplotypeCaller -R ${projdir}/refgenomes/$ref1 -L ${projdir}/refgenomes/${ref1%.f*}.list ${input}-ploidy $ploidy -O ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref3%.f*}_${ploidy}x_raw.vcf.gz --max-reads-per-alignment-start 0 --minimum-mapping-quality $minmapq --max-num-haplotypes-in-population $((ploidy * maxHaplotype)) &&
              cd ../snpcall
        ...
        if [[ "$ploidy_ref2" && "$ploidy_ref3" ]]; then
          ...
          if [[ -z "$Get_Chromosome" ]]; then
            ...
            if [[ "$(ls ${projdir}/snpcall/${pop}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_${selchr}_raw.vcf* 2> /dev/null | wc -l)" -eq 0 ]]; then
              ...
              $GATK --java-options "$Xmx2 -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" HaplotypeCaller -R ${projdir}/refgenomes/$ref2 -L ${projdir}/refgenomes/${ref2%.f*}.list ${input}-ploidy $ploidy -O ${projdir}/snpcall/${pop}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_raw.vcf.gz --max-reads-per-alignment-start 0 --minimum-mapping-quality $minmapq --max-num-haplotypes-in-population $((ploidy * maxHaplotype)) &&
              cd ../snpcall
        ...
        if [[ "$ploidy_ref3" ]]; then
          ...
          Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/${ref3%.f*}.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}' | awk -v pat=${ref3%.f*} '$0 ~ pat' )
          if [[ -n "$Exclude_Chromosome" ]]; then
            for i in $(echo "$Exclude_Chromosome" | tr ',' '\n'); do
              Get2_Chromosome=$(echo $Get2_Chromosome | awk -v i=$i '{gsub(i,"");}1')
            done
          ...
          if [[ -z "$Get_Chromosome" ]]; then
            ...
            if [[ "$(ls ${projdir}/snpcall/${pop}_${ref3%.f*}_${ploidy_ref3}x_${selchr}_raw.vcf* 2> /dev/null | wc -l)" -eq 0 ]]; then
              ...
              $GATK --java-options "$Xmx2 -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" HaplotypeCaller -R ${projdir}/refgenomes/$ref3 -L ${projdir}/refgenomes/${ref3%.f*}.list ${input}-ploidy $ploidy -O ${projdir}/snpcall/${pop}_${ref3%.f*}_${ploidy_ref3}x_raw.vcf.gz --max-reads-per-alignment-start 0 --minimum-mapping-quality $minmapq --max-num-haplotypes-in-population $((ploidy_ref3 * maxHaplotype)) &&
              cd ../snpcall
      ...
      while IFS="" read -r i || [ -n "$i" ]; do (
        ...
        mv ${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_precall.bam* ${projdir}/preprocess/processed/ 2> /dev/null
        ...
        if [[ $call123 == $nodes ]]; then
          ...
          for dir in cohorts*/; do
            ...
            for selchr in $Get2_Chromosome; do (
              ...
              if [[ -z "$interval_list" ]]; then
                $GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_${selchr}_raw --genomicsdb-shared-posixfs-optimizations true --batch-size 50 --merge-input-intervals &&
                wait
              else
                cat ${projdir}/${interval_list} | grep $selchr > ${projdir}/variant_intervals_${selchr}.list &&
            ...
            for selchr in $Get2_Chromosome; do (
              ...
              if test ! -f "${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_${selchr}_raw.vcf.gz"; then
                if [[ -z "$interval_list" ]]; then
                  $GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/$ref1 -L ${selchr} -V gendb://${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_${selchr}_raw -O ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_${selchr}_raw.hold.vcf.gz && \
                  ...
                  mv ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_${selchr}_raw.hold.vcf.gz.tbi ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_${selchr}_raw.vcf.gz.tb &&
                  wait
                else
                  cat ${projdir}/${interval_list} | grep $selchr > ${projdir}/variant_intervals_${selchr}.list &&
                  $GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/$ref1 -L ${projdir}/variant_intervals_${selchr}.list -V gendb://${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_${selchr}_raw -O ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_${selchr}_raw.hold.vcf.gz && \
                  rm ${projdir}/variant_intervals_${selchr}.list &&
                  rm -r ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_${selchr}_raw && \
                  mv "${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_${selchr}_raw.hold.vcf.gz" "${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ploidy}x_${selchr}_raw.vcf.gz"
          ...
          if [[ $call12 == $nodes ]]; then
            ...
            for dir in cohorts*/; do
              ...
              for selchr in $Get2_Chromosome; do (
                export TILEDB_DISABLE_FILE_LOCKING=1
                if [[ -z "$interval_list" ]]; then
                  $GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref1%.f*}_${ref2%.f*}_${calcploidy}x_${selchr}_raw --genomicsdb-shared-posixfs-optimizations true --batch-size 50 --merge-input-intervals &&
                  wait
                else
                  cat ${projdir}/${interval_list} | grep $selchr > ${projdir}/variant_intervals_${selchr}.list &&
              ...
              for selchr in $Get2_Chromosome; do (
                ...
                if test ! -f "${pop}_${ref1%.f*}_${ref2%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"; then
                  if [[ -z "$interval_list" ]]; then
                    $GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/$ref1 -L ${selchr} -V gendb://${pop}_${ref1%.f*}_${ref2%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref1%.f*}_${ref2%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
                    ...
                    mv ${pop}_${ref1%.f*}_${ref2%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz.tbi ${pop}_${ref1%.f*}_${ref2%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz.tb &&
                    wait
                  else
                    cat ${projdir}/${interval_list} | grep $selchr > ${projdir}/variant_intervals_${selchr}.list &&
                    $GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/$ref1 -L ${projdir}/variant_intervals_${selchr}.list -V gendb://${pop}_${ref1%.f*}_${ref2%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref1%.f*}_${ref2%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
                    rm ${projdir}/variant_intervals_${selchr}.list &&
                    rm -r ${pop}_${ref1%.f*}_${ref2%.f*}_${calcploidy}x_${selchr}_raw && \
                    mv "${pop}_${ref1%.f*}_${ref2%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz" "${pop}_${ref1%.f*}_${ref2%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"
      ...
      if [[ "$ploidy_ref1" && "$ploidy_ref3" ]]; then
        ...
        while IFS="" read -r i || [ -n "$i" ]; do (
          ...
          mv ${i%.f*}_${ref1%.f*}_${ref3%.f*}_precall.bam* ${projdir}/preprocess/processed/ 2> /dev/null
          ...
          if [[ $call13 == $nodes ]]; then
            ...
            for dir in cohorts*/; do
              ...
              for selchr in $Get2_Chromosome; do (
                export TILEDB_DISABLE_FILE_LOCKING=1
                if [[ -z "$interval_list" ]]; then
                  $GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw --genomicsdb-shared-posixfs-optimizations true --batch-size 50 --merge-input-intervals &&
                  wait
                else
                  cat ${projdir}/${interval_list} | grep $selchr > ${projdir}/variant_intervals_${selchr}.list &&
              ...
              for selchr in $Get2_Chromosome; do (
                ...
                if test ! -f "${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"; then
                  if [[ -z "$interval_list" ]]; then
                    $GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/$ref1 -L ${selchr} -V gendb://${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
                    ...
                    mv ${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz.tbi ${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz.tb &&
                    wait
                  else
                    cat ${projdir}/${interval_list} | grep $selchr > ${projdir}/variant_intervals_${selchr}.list &&
                    $GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/$ref1 -L ${projdir}/variant_intervals_${selchr}.list -V gendb://${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
                    rm ${projdir}/variant_intervals_${selchr}.list &&
                    rm -r ${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw && \
                    mv "${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz" "${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"
      ...
      if [[ "$ploidy_ref2" && "$ploidy_ref3" ]]; then
        ...
        while IFS="" read -r i || [ -n "$i" ]; do (
          ...
          mv ${i%.f*}_${ref2%.f*}_${ref3%.f*}_precall.bam* ${projdir}/preprocess/processed/ 2> /dev/null
          ...
          if [[ $call23 == $nodes ]]; then
            ...
            for dir in cohorts*/; do
              ...
              for selchr in $Get2_Chromosome; do (
                export TILEDB_DISABLE_FILE_LOCKING=1
                if [[ -z "$interval_list" ]]; then
                  $GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw --genomicsdb-shared-posixfs-optimizations true --batch-size 50 --merge-input-intervals &&
                  wait
                else
                  cat ${projdir}/${interval_list} | grep $selchr > ${projdir}/variant_intervals_${selchr}.list &&
              ...
              for selchr in $Get2_Chromosome; do (
                ...
                if test ! -f "${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"; then
                  if [[ -z "$interval_list" ]]; then
                    $GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/$ref2 -L ${selchr} -V gendb://${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
                    ...
                    mv ${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz.tbi ${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz.tb &&
                    wait
                  else
                    cat ${projdir}/${interval_list} | grep $selchr > ${projdir}/variant_intervals_${selchr}.list &&
                    $GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/$ref2 -L ${projdir}/variant_intervals_${selchr}.list -V gendb://${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
                    rm ${projdir}/variant_intervals_${selchr}.list &&
                    rm -r ${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw && \
                    mv "${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz" "${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"
      ...
      if [[ "$ploidy_ref3" ]]; then
        ...
        while IFS="" read -r i || [ -n "$i" ]; do (
          ...
          mv ${i%.f*}_${ref3%.f*}_precall.bam* ${projdir}/preprocess/processed/ 2> /dev/null
          ...
          if [[ $call3 == $nodes ]]; then
            ...
            for dir in cohorts*/; do
              ...
              for selchr in $Get2_Chromosome; do (
                export TILEDB_DISABLE_FILE_LOCKING=1
                if [[ -z "$interval_list_ref3" ]]; then
                  $GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref3%.f*}_${ploidy_ref3}x_${selchr}_raw --genomicsdb-shared-posixfs-optimizations true --batch-size 50 --merge-input-intervals &&
                  wait
                else
                  cat ${projdir}/${interval_list_ref3} | grep $selchr > ${projdir}/variant_intervals_${selchr}.list &&
              ...
              for selchr in $Get2_Chromosome; do (
                ...
                if test ! -f "${pop}_${ref3%.f*}_${ploidy_ref3}x_${selchr}_raw.vcf.gz"; then
                  if [[ -z "$interval_list_ref3" ]]; then
                    $GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/$ref3 -L ${selchr} -V gendb://${pop}_${ref3%.f*}_${ploidy_ref3}x_${selchr}_raw -O ${pop}_${ref3%.f*}_${ploidy_ref3}x_${selchr}_raw.hold.vcf.gz && \
                    ...
                    cat ${projdir}/${interval_list_ref3} | grep $selchr > ${projdir}/variant_intervals_${selchr}.list &&
                    $GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/$ref3 -L ${projdir}/variant_intervals_${selchr}.list -V gendb://${pop}_${ref3%.f*}_${ploidy_ref3}x_${selchr}_raw -O ${pop}_${ref3%.f*}_${ploidy_ref3}x_${selchr}_raw.hold.vcf.gz && \
                    rm ${projdir}/variant_intervals_${selchr}.list &&
                    rm -r ${pop}_${ref3%.f*}_${ploidy_ref3}x_${selchr}_raw && \
                    mv ${pop}_${ref3%.f*}_${ploidy_ref3}x_${selchr}_raw.hold.vcf.gz ${pop}_${ref3%.f*}_${ploidy_ref3}x_${selchr}_raw.vcf.gz &&
                    wait
