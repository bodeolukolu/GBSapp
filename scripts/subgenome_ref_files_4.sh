...
main () {
	...
	if [[ "$mhap_freq" -gt 0 ]] && [[ ! -f "${projdir}/alignment_summaries/background_mutation_test/pop_haps_freqFail.txt" ]]; then
		if [[ "$samples_list" == "samples_list_node_1.txt" ]]; then
			for i in $(cat ${projdir}/samples_list_node_* ); do
			...
			touch ${projdir}/pophaps_filter_${samples_list}
	...
	wait && touch ${projdir}/compress_done

	cd ${projdir}/samples

	if [[ $nodes -gt 1 ]]; then
		mkdir -p /tmp/${samples_list%.txt}/refgenomes /tmp/${samples_list%.txt}/samples /tmp/${samples_list%.txt}/preprocess /tmp/${samples_list%.txt}/preprocess/processed /tmp/${samples_list%.txt}/snpcall
		...
		if [[ "$lib_type" == "WGS" ]]; then
			for i in $(cat ${projdir}/${samples_list} ); do
				mv ${projdir}/samples/${i} /tmp/${samples_list%.txt}/samples/ &&
				mv ${projdir}/samples/${i%.f*}_R2.fastq.gz /tmp/${samples_list%.txt}/samples/ &&
				cp ${projdir}/preprocess/${i%.f*}_redun.sam.gz /tmp/${samples_list%.txt}/preprocess/ 2> /dev/null &&
				cp ${projdir}/preprocess/${i%.f*}_*_precall.bam* /tmp/${samples_list%.txt}/preprocess/ 2> /dev/null &&
				wait
			done
	...
	for i in $(cat ${projdir}/${samples_list} ); do
		...
		if [[ "$lib_type" == "RRS" ]] && test -f ${projdir}/compress_done && test ! -f ${projdir}/precall_done.txt && test ! -f ${projdir}/preprocess/${i%.f*}_${ref1%.f*}_precall.bam.bai; then
			...
			if test ! -f ../preprocess/${i%.f*}_redun.sam.gz; then
				if [[ "$nempty" -gt 0 ]]; then
					$ngm -r ../refgenomes/panref.fasta --qry ${i%.f*}_uniq_R1.fq.gz -o ../preprocess/${i%.f*}_redun_R1.sam -t $threads --min-identity 0 --topn 12 -strata 12 &&
					$ngm -r ../refgenomes/panref.fasta --qry ${i%.f*}_uniq_R2.fq.gz -o ../preprocess/${i%.f*}_redun_R2.sam -t $threads --min-identity 0 --topn 12 --strata 12 &&
					if [[ -s ../preprocess/${i%.f*}_redun_singleton.sam ]]; then $ngm -r ../refgenomes/panref.fasta --qry ${i%.f*}_uniq_singleton.fq.gz -o ../preprocess/${i%.f*}_redun_singleton.sam -t $threads --min-identity 0 --topn 12 --strata 12; fi &&
					...
					if [[ -s ../preprocess/${i%.f*}_redun_singleton.sam ]]; then grep -v '^@' ../preprocess/${i%.f*}_redun_singleton.sam >> ../preprocess/${i%.f*}_redun.hold.sam; fi &&
					$gzip ../preprocess/${i%.f*}_redun.hold.sam &&
					mv ../preprocess/${i%.f*}_redun.hold.sam.gz ../preprocess/${i%.f*}_redun.sam.gz 2> /dev/null &&
					rm ../samples/${i%.f*}_uniq*.fq.gz 2> /dev/null &&
					wait
				else
					$ngm -r ../refgenomes/panref.fasta --qry ../samples/${i%.f*}_uniq_R1.fq.gz -o ../preprocess/${i%.f*}_redun.hold.sam -t $threads --min-identity 0 --topn 12 --strata 12 &&
					$gzip ../preprocess/${i%.f*}_redun.hold.sam &&
					mv ../preprocess/${i%.f*}_redun.hold.sam.gz ../preprocess/${i%.f*}_redun.sam.gz 2> /dev/null &&
					rm ../samples/${i%.f*}_uniq*.fq.gz &&
					wait
				fi
				rm ../preprocess/${i%.f*}_redun_singleton.sam ../preprocess/${i%.f*}_redun_R*.sam 2> /dev/null &&
				wait
			fi
			wait
		fi
	...
	for i in $(cat ${projdir}/${samples_list} ); do
		if [[ $nodes -eq 1 ]]; then cd ${projdir}/samples/ ; fi
		if [[ $nodes -gt 1 ]]; then cd /tmp/${samples_list%.txt}/samples/ ; fi
		if [[ "$lib_type" == "WGS" ]] && test ${projdir}/compress_done_${samples_list}  && test ! -f ${projdir}/precall_done.txt && test ! -f ${projdir}/preprocess/${i%.f*}_${ref1%.f*}_precall.bam.bai; then
	...
	for i in $( cat ${projdir}/${samples_list} ); do (
		...
		if [[ $nodes -gt 1 ]]; then cd /tmp/${samples_list%.txt}/preprocess/; fi
		...
		if test ! -f ${projdir}/preprocess/${i%.f*}_${ref1%.f*}_precall.bam.bai && test ! -f ${projdir}/preprocess/${i%.f*}_${ref2%.f*}_precall.bam.bai && test ! -f ${projdir}/preprocess/${i%.f*}_${ref1%.f*}_${ref2%.f*}_precall.bam.bai; then
			...
			$samtools flagstat <(zcat ${i%.f*}_redun.sam.gz 2> /dev/null) >> ${projdir}/alignment_summaries/${i%.f*}_summ.txt && \
			printf '########################################################################################################\n\n' >> ${projdir}/alignment_summaries/${i%.f*}_summ.txt && \
      ...
      echo "nloci~POS~mapQ~CHROM~CHROM" > ${projdir}/alignment_summaries/refgenome_paralogs_${i%.f*}_${ref3%.f*}.txt
        ...
        awk '/@HD/ || /@SQ/{print}' <(zcat ${i%.f*}_redun.sam.gz 2> /dev/null) > ${i%.f*}_heading_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam
				...
				for j in $(LC_ALL=C; sort -n -k1,1 ${i%.f*}_uniq_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam | awk '{print $1}' | uniq); do
				  awk -v n="^${j}" '$0~n{print $0}' ${i%.f*}_uniq_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam | awk -v n="$j" '{for(i=0;i<n;i++) print}' >> ${i%.f*}_exp_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam
				done; wait
        ...
        awk '/@HD/ || /@SQ/{print}' <(zcat ${i%.f*}_redun.sam.gz 2> /dev/null) > ${i%.f*}_heading_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}.sam
				...
				for j in $(LC_ALL=C; sort -n -k1,1 ${i%.f*}_uniq_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}.sam | awk '{print $1}' | uniq); do
				  awk -v n="^${j}" '$0~n{print $0}' ${i%.f*}_uniq_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}.sam | awk -v n="$j" '{for(i=0;i<n;i++) print}' >> ${i%.f*}_exp_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}.sam
				done; wait
        ...
        awk '/@HD/ || /@SQ/{print}' <(zcat ${i%.f*}_redun.sam.gz 2> /dev/null) > ${i%.f*}_heading_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}.sam
				...
				for j in $(LC_ALL=C; sort -n -k1,1 ${i%.f*}_uniq_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}.sam | awk '{print $1}' | uniq); do
				  awk -v n="^${j}" '$0~n{print $0}' ${i%.f*}_uniq_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}.sam | awk -v n="$j" '{for(i=0;i<n;i++) print}' >> ${i%.f*}_exp_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}.sam
				done; wait
        ...
        awk '/@HD/ || /@SQ/{print}' <(zcat ${i%.f*}_redun.sam.gz 2> /dev/null) > ${i%.f*}_heading_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}.sam
				...
				for j in $(LC_ALL=C; sort -n -k1,1 ${i%.f*}_uniq_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}.sam | awk '{print $1}' | uniq); do
				  awk -v n="^${j}" '$0~n{print $0}' ${i%.f*}_uniq_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}.sam | awk -v n="$j" '{for(i=0;i<n;i++) print}' >> ${i%.f*}_exp_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}.sam
				done; wait
        ...
        awk '/@HD/ || /@SQ/{print}' <(zcat ${i%.f*}_redun.sam.gz 2> /dev/null) > ${i%.f*}_heading_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam
				...
				for j in $(LC_ALL=C; sort -n -k1,1 ${i%.f*}_uniq_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam | awk '{print $1}' | uniq); do
				  awk -v n="^${j}" '$0~n{print $0}' ${i%.f*}_uniq_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam | awk -v n="$j" '{for(i=0;i<n;i++) print}' >> ${i%.f*}_exp_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam
				done; wait
        ...
        for j in $(LC_ALL=C; sort -n -k1,1 ${i%.f*}_uniq_${ref1%.f*}_${ref2%.f*}.sam | awk '{print $1}' | uniq); do
        	awk -v n="^${j}" '$0~n{print $0}' ${i%.f*}_uniq_${ref1%.f*}_${ref2%.f*}.sam | awk -v n="$j" '{for(i=0;i<n;i++) print}' >> ${i%.f*}_exp_${ref1%.f*}_${ref2%.f*}.sam
        done; wait
        ...
        for j in $(LC_ALL=C; sort -n -k1,1 ${i%.f*}_uniq_${ref1%.f*}_${ref3%.f*}.sam | awk '{print $1}' | uniq); do
        	awk -v n="^${j}" '$0~n{print $0}' ${i%.f*}_uniq_${ref1%.f*}_${ref3%.f*}.sam | awk -v n="$j" '{for(i=0;i<n;i++) print}' >> ${i%.f*}_exp_${ref1%.f*}_${ref3%.f*}.sam
        done; wait
        ...
        for j in $(LC_ALL=C; sort -n -k1,1 ${i%.f*}_uniq_${ref1%.f*}_${ref4%.f*}.sam | awk '{print $1}' | uniq); do
        	awk -v n="^${j}" '$0~n{print $0}' ${i%.f*}_uniq_${ref1%.f*}_${ref4%.f*}.sam | awk -v n="$j" '{for(i=0;i<n;i++) print}' >> ${i%.f*}_exp_${ref1%.f*}_${ref4%.f*}.sam
        done; wait
        ...
        for j in $(LC_ALL=C; sort -n -k1,1 ${i%.f*}_uniq_${ref2%.f*}_${ref3%.f*}.sam | awk '{print $1}' | uniq); do
        	awk -v n="^${j}" '$0~n{print $0}' ${i%.f*}_uniq_${ref2%.f*}_${ref3%.f*}.sam | awk -v n="$j" '{for(i=0;i<n;i++) print}' >> ${i%.f*}_exp_${ref2%.f*}_${ref3%.f*}.sam
        done; wait
        ...
        for j in $(LC_ALL=C; sort -n -k1,1 ${i%.f*}_uniq_${ref2%.f*}_${ref4%.f*}.sam | awk '{print $1}' | uniq); do
        	awk -v n="^${j}" '$0~n{print $0}' ${i%.f*}_uniq_${ref2%.f*}_${ref4%.f*}.sam | awk -v n="$j" '{for(i=0;i<n;i++) print}' >> ${i%.f*}_exp_${ref2%.f*}_${ref4%.f*}.sam
        done; wait
        ...
        for j in $(LC_ALL=C; sort -n -k1,1 ${i%.f*}_uniq_${ref3%.f*}_${ref4%.f*}.sam | awk '{print $1}' | uniq); do
        	awk -v n="^${j}" '$0~n{print $0}' ${i%.f*}_uniq_${ref3%.f*}_${ref4%.f*}.sam | awk -v n="$j" '{for(i=0;i<n;i++) print}' >> ${i%.f*}_exp_${ref3%.f*}_${ref4%.f*}.sam
        done; wait
        ...
        rm ${i%.f*}_exp_${ref3%.f*}_${ref4%.f*}.sam ${i%.f*}_uniq_${ref3%.f*}_${ref4%.f*}.sam ${i%.f*}_heading_${ref3%.f*}_${ref4%.f*}.sam ${i%.f*}_del_${ref3%.f*}_${ref4%.f*}.sam
...

			{
				...
				for j in $(LC_ALL=C; sort -n -k1,1 ${i%.f*}_uniq_${ref1%.f*}.sam | awk '{print $1}' | uniq); do
				  awk -v n="^${j}" '$0~n{print $0}' ${i%.f*}_uniq_${ref1%.f*}.sam | awk -v n="$j" '{for(i=0;i<n;i++) print}' >> ${i%.f*}_exp_${ref1%.f*}.sam
				done; wait
...

			{
				...
				for j in $(LC_ALL=C; sort -n -k1,1 ${i%.f*}_uniq_${ref2%.f*}.sam | awk '{print $1}' | uniq); do
				  awk -v n="^${j}" '$0~n{print $0}' ${i%.f*}_uniq_${ref2%.f*}.sam | awk -v n="$j" '{for(i=0;i<n;i++) print}' >> ${i%.f*}_exp_${ref2%.f*}.sam
				done; wait
        ...
        awk '/@HD/ || /@SQ/{print}' <(zcat ${i%.f*}_redun.sam.gz 2> /dev/null) > ${i%.f*}_heading_${ref3%.f*}.sam
				...
				for j in $(LC_ALL=C; sort -n -k1,1 ${i%.f*}_uniq_${ref3%.f*}.sam | awk '{print $1}' | uniq); do
				  awk -v n="^${j}" '$0~n{print $0}' ${i%.f*}_uniq_${ref3%.f*}.sam | awk -v n="$j" '{for(i=0;i<n;i++) print}' >> ${i%.f*}_exp_${ref3%.f*}.sam
				done; wait
...

			{
				...
				for j in $(LC_ALL=C; sort -n -k1,1 ${i%.f*}_uniq_${ref4%.f*}.sam | awk '{print $1}' | uniq); do
				  awk -v n="^${j}" '$0~n{print $0}' ${i%.f*}_uniq_${ref4%.f*}.sam | awk -v n="$j" '{for(i=0;i<n;i++) print}' >> ${i%.f*}_exp_${ref4%.f*}.sam
				done; wait
