...
main () {
	...
	if [[ "${joint_alignment}" -eq 1 ]]; then
		  ...
		  if test ! -f ${projdir}/precall_done.txt && test ! -f ${projdir}/alignment_done; then
				for alignfq in $( cat ${projdir}/samples_list_node_* ); do
		      if [[ -z "${alignfq%.f*}_uniq_R2.fasta.gz" ]]; then :> ${alignfq%.f*}_uniq_R2.fasta && gzip ${alignfq%.f*}_uniq_R2.fasta; fi
		      if test ! -f ../preprocess/${alignfq%.f*}_redun.sam.gz; then
		        zcat ${alignfq%.f*}_uniq_R1.fasta.gz ${alignfq%.f*}_uniq_R2.fasta.gz | awk '{gsub(/>/,"@");}1'| awk '{print $1"\t"$2"\t"$2}' | \
						awk 'BEGIN{OFS="\t"}{gsub(/A|a|C|c|G|g|T|t|N|n/,"I",$3); print}' | awk '{print $1"\n"$2"\n+\n"$3}'| gzip > ${alignfq%.f*}_uniq.fasta.gz &&
		        $ngm -r ../refgenomes/panref.fasta --qry ${alignfq%.f*}_uniq.fasta.gz -o ../preprocess/${alignfq%.f*}.sam -t $threads --min-identity 0 --topn 12 --strata 12 &&
		        $java $Xmx2 -XX:ParallelGCThreads=$threads -Djava.io.tmpdir=`pwd`/tmp -jar $picard SortSam I=../preprocess/${alignfq%.f*}.sam O=../preprocess/${alignfq%.f*}.bam  SORT_ORDER=coordinate  VALIDATION_STRINGENCY=LENIENT TMP_DIR=`pwd`/tmp &&
		        rm ${alignfq%.f*}_uniq.fasta.gz ../preprocess/${alignfq%.f*}.sam &&
		        $samtools view -h ../preprocess/${alignfq%.f*}.bam | $gzip > ../preprocess/${alignfq%.f*}_redun.sam.gz &&
		        rm ../preprocess/${alignfq%.f*}.bam
		        wait
		      fi
		    done
		  fi
    ...
    if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${ploidy}x_raw.vcf*; then
    	...
    	if [[ $call1234 == $nodes ]]; then
    		...
    		for dir in cohorts*/; do
    			...
    			for selchr in $Get2_Chromosome; do
    				$GATK --java-options "$Xmxp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${ploidy}x_${selchr}_raw
						wait
    			done
    			for selchr in $Get2_Chromosome; do (
    				if test ! -f "${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${ploidy}x_${selchr}_raw.vcf.gz"; then
    					$GATK --java-options "$Xmx1 -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${ploidy}x_${selchr}_raw -O ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${ploidy}x_${selchr}_raw.hold.vcf.gz && \
    ...
    if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_raw.vcf*; then
    	...
    	if [[ $call123 == $nodes ]]; then
    		...
    		for dir in cohorts*/; do
    			...
    			for selchr in $Get2_Chromosome; do
    				$GATK --java-options "$Xmxp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw
						wait
    			done
    			for selchr in $Get2_Chromosome; do (
    				if test ! -f "${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"; then
    					$GATK --java-options "$Xmx1 -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
    ...
    if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf*; then
    	...
    	if [[ $call124 == $nodes ]]; then
    		...
    		for dir in cohorts*/; do
    			...
    			for selchr in $Get2_Chromosome; do
    				$GATK --java-options "$Xmxp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw
						wait
    			done
    			for selchr in $Get2_Chromosome; do (
    				if test ! -f "${pop}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"; then
    					$GATK --java-options "$Xmx1 -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
    ...
    if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf*; then
    	...
    	if [[ $call134 == $nodes ]]; then
    		...
    		for dir in cohorts*/; do
    			...
    			for selchr in $Get2_Chromosome; do
    				$GATK --java-options "$Xmxp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw
						wait
    			done
    			for selchr in $Get2_Chromosome; do (
    				if test ! -f "${pop}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"; then
    					$GATK --java-options "$Xmx1 -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
    ...
    if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf*; then
    	...
    	if [[ $call234 == $nodes ]]; then
    		...
    		for dir in cohorts*/; do
    			...
    			for selchr in $Get2_Chromosome; do
    				$GATK --java-options "$Xmxp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw
						wait
    			done
    			for selchr in $Get2_Chromosome; do (
    				if test ! -f "${pop}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"; then
    					$GATK --java-options "$Xmx1 -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
    ...
    if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${calcploidy}x_raw.vcf*; then
    	...
    	if [[ $call12 == $nodes ]]; then
    		...
    		for dir in cohorts*/; do
    			...
    			for selchr in $Get2_Chromosome; do
    				$GATK --java-options "$Xmxp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref1%.f*}_${ref2%.f*}_${calcploidy}x_${selchr}_raw
						wait
    			done
    			for selchr in $Get2_Chromosome; do (
    				if test ! -f "${pop}_${ref1%.f*}_${ref2%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"; then
    					$GATK --java-options "$Xmx1 -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref1%.f*}_${ref2%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref1%.f*}_${ref2%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
    ...
    if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_raw.vcf*; then
    	...
    	if [[ $call13 == $nodes ]]; then
    		...
    		for dir in cohorts*/; do
    			...
    			for selchr in $Get2_Chromosome; do
    				$GATK --java-options "$Xmxp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw
						wait
    			done
    			for selchr in $Get2_Chromosome; do (
    				if test ! -f "${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"; then
    					$GATK --java-options "$Xmx1 -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
    ...
    if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf*; then
    	...
    	if [[ $call14 == $nodes ]]; then
    		...
    		for dir in cohorts*/; do
    			...
    			for selchr in $Get2_Chromosome; do
    				$GATK --java-options "$Xmxp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref1%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw
						wait
    			done
    			for selchr in $Get2_Chromosome; do (
    				if test ! -f "${pop}_${ref1%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"; then
    					$GATK --java-options "$Xmx1 -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref1%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref1%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
    ...
    if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_raw.vcf*; then
    	...
    	if [[ $call23 == $nodes ]]; then
    		...
    		for dir in cohorts*/; do
    			...
    			for selchr in $Get2_Chromosome; do
    				$GATK --java-options "$Xmxp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw
						wait
    			done
    			for selchr in $Get2_Chromosome; do (
    				if test ! -f "${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"; then
    					$GATK --java-options "$Xmx1 -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
    ...
    if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf*; then
    	...
    	if [[ $call24 == $nodes ]]; then
    		...
    		for dir in cohorts*/; do
    			...
    			for selchr in $Get2_Chromosome; do (
    				$GATK --java-options "$Xmxp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw ) &
						if [[ $(jobs -r -p | wc -l) -ge $gN ]]; then
							wait
						fi
    			done
    			for selchr in $Get2_Chromosome; do (
    				if test ! -f "${pop}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"; then
    					$GATK --java-options "$Xmx1 -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
    ...
    if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf*; then
    	...
    	if [[ $call34 == $nodes ]]; then
    		...
    		for dir in cohorts*/; do
    			...
    			for selchr in $Get2_Chromosome; do (
    				$GATK --java-options "$Xmxp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw ) &
						if [[ $(jobs -r -p | wc -l) -ge $gN ]]; then
							wait
						fi
    			done
    			for selchr in $Get2_Chromosome; do (
    				if test ! -f "${pop}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"; then
    					$GATK --java-options "$Xmx1 -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
			...
			if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f $${projdir}/snpcall/{pop}_${ref1%.f*}_${ploidy_ref1}x_raw.vcf*; then
			  ...
			  if [[ $call1 == $nodes ]]; then
					...
					for dir in cohorts*/; do
						...
						for selchr in $Get2_Chromosome; do
							$GATK --java-options "$Xmxp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref1%.f*}_${ploidy_ref1}x_${selchr}_raw
							wait
						done
						for selchr in $Get2_Chromosome; do (
							if test ! -f "${pop}_${ref1%.f*}_${ploidy_ref1}x_${selchr}_raw.vcf.gz"; then
								$GATK --java-options "$Xmx1 -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref1%.f*}_${ploidy_ref1}x_${selchr}_raw -O ${pop}_${ref1%.f*}_${ploidy_ref1}x_${selchr}_raw.hold.vcf.gz && \
			...
			if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref2%.f*}_${ploidy_ref2}x_raw.vcf*; then
			  ...
			  if [[ $call2 == $nodes ]]; then
					...
					for dir in cohorts*/; do
						...
						for selchr in $Get2_Chromosome; do
							$GATK --java-options "$Xmxp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref2%.f*}_${ploidy_ref2}x_${selchr}_raw
							wait
						done
						for selchr in $Get2_Chromosome; do (
							if test ! -f "${pop}_${ref2%.f*}_${ploidy_ref2}x_${selchr}_raw.vcf.gz"; then
								$GATK --java-options "$Xmx1 -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref2%.f*}_${ploidy_ref2}x_${selchr}_raw -O ${pop}_${ref2%.f*}_${ploidy_ref2}x_${selchr}_raw.hold.vcf.gz && \
			...
			if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f $${projdir}/snpcall/{pop}_${ref3%.f*}_${ploidy_ref3}x_raw.vcf*; then
			  ...
			  if [[ $call3 == $nodes ]]; then
					...
					for dir in cohorts*/; do
						...
						for selchr in $Get2_Chromosome; do
							$GATK --java-options "$Xmxp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref3%.f*}_${ploidy_ref3}x_${selchr}_raw
							wait
						done
						for selchr in $Get2_Chromosome; do (
							if test ! -f "${pop}_${ref3%.f*}_${ploidy_ref3}x_${selchr}_raw.vcf.gz"; then
								$GATK --java-options "$Xmx1 -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref3%.f*}_${ploidy_ref3}x_${selchr}_raw -O ${pop}_${ref3%.f*}_${ploidy_ref3}x_${selchr}_raw.hold.vcf.gz && \
  			...
  			if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f $${projdir}/snpcall/{pop}_${ref4%.f*}_${ploidy_ref4}x_raw.vcf*; then
  			  ...
  			  if [[ $call4 == $nodes ]]; then
  					...
  					for dir in cohorts*/; do
  						...
  						for selchr in $Get2_Chromosome; do
  							$GATK --java-options "$Xmxp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref4%.f*}_${ploidy_ref4}x_${selchr}_raw
								wait
  						done
  						for selchr in $Get2_Chromosome; do (
  							if test ! -f "${pop}_${ref4%.f*}_${ploidy_ref4}x_${selchr}_raw.vcf.gz"; then
  								$GATK --java-options "$Xmx1 -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref4%.f*}_${ploidy_ref4}x_${selchr}_raw -O ${pop}_${ref4%.f*}_${ploidy_ref4}x_${selchr}_raw.hold.vcf.gz && \
