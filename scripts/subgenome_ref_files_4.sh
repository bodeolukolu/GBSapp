...
if ls ./*.ngm 1> /dev/null 2>&1; then
	...
	if [[ $ncontigscaffold -gt 3000 ]]; then
		mkdir split
		for reffile in $(ls *.f* 2> /dev/null); do
...
main () {
	...
	if [[ "${joint_alignment}" -eq 1 ]]; then
		  ...
		  if test ! -f ${projdir}/precall_done.txt && test ! -f ${projdir}/alignment_done; then
		    for alignfq in $( cat ${projdir}/${samples_list} ); do
		      if test ! -f ../preprocess/${alignfq%.f*}_redun.sam.gz; then
  		        zcat ${alignfq%.f*}_uniq_*.fasta.gz | awk '{gsub(/>/,"@");}1'| awk '{print $1"\t"$2"\t"$2}' | \
  						awk 'BEGIN{OFS="\t"}{gsub(/A|a|C|c|G|g|T|t|N|n/,"I",$3); print}' | awk '{print $1"\n"$2"\n+\n"$3}'| gzip > ${alignfq%.f*}_uniq.fasta.gz &&
  		        $ngm -r ../refgenomes/panref.fasta --qry ${alignfq%.f*}_uniq.fasta.gz -o ../preprocess/${alignfq%.f*}_redun.sam -t $threads --min-identity 0 --topn 12 --strata 12 &&
              $gzip ../preprocess/${alignfq%.f*}_redun.sam
		  ...
		  if [[ "$nodes" -gt 1 ]]; then
		    cp -rn ${projdir}/preprocess/*_redun.sam.gz /tmp/${samples_list%.txt}/preprocess/
		  fi
		  wait
		  ...
		  for i in $(cat ${projdir}/${samples_list} ); do (
		    ...
		    if test ! -f ${projdir}/preprocess/${i%.f*}_${ref1%.f*}_precall.bam.bai && test ! -f ${projdir}/preprocess/${i%.f*}_${ref2%.f*}_precall.bam.bai && test ! -f ${projdir}/preprocess/${i%.f*}_${ref1%.f*}_${ref2%.f*}_precall.bam.bai; then
		      ...
		      echo "nloci~mapQ~CHROM~POS" > ${projdir}/alignment_summaries/refgenome_paralogs_${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.txt
		      ...
		      echo "nloci~mapQ~CHROM~POS" > ${projdir}/alignment_summaries/refgenome_paralogs_${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}.txt
		      ...
		      echo "nloci~mapQ~CHROM~POS" > ${projdir}/alignment_summaries/refgenome_paralogs_${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}.txt
		      ...
		      awk '!visited[$0]++' ${projdir}/alignment_summaries/refgenome_paralogs_${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.txt > ${projdir}/alignment_summaries/temp_${i%.f*}.txt
		      mv ${projdir}/alignment_summaries/temp_${i%.f*}.txt ${projdir}/alignment_summaries/refgenome_paralogs_${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.txt
		      echo "nloci~mapQ~CHROM~POS" > ${projdir}/alignment_summaries/refgenome_paralogs_${i%.f*}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}.txt
		      ...
		      echo "nloci~mapQ~CHROM~POS" > ${projdir}/alignment_summaries/refgenome_paralogs_${i%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.txt
		      ...
		      echo "nloci~mapQ~CHROM~POS" > ${projdir}/alignment_summaries/refgenome_paralogs_${i%.f*}_${ref1%.f*}_${ref3%.f*}.txt
		      ...
		      echo "nloci~mapQ~CHROM~POS" > ${projdir}/alignment_summaries/refgenome_paralogs_${i%.f*}_${ref1%.f*}_${ref4%.f*}.txt
		      ...
		      echo "nloci~mapQ~CHROM~POS" > ${projdir}/alignment_summaries/refgenome_paralogs_${i%.f*}_${ref2%.f*}_${ref3%.f*}.txt
		      ...
		      echo "nloci~mapQ~CHROM~POS" > ${projdir}/alignment_summaries/refgenome_paralogs_${i%.f*}_${ref2%.f*}_${ref4%.f*}.txt
		      ...
		      echo "nloci~mapQ~CHROM~POS" > ${projdir}/alignment_summaries/refgenome_paralogs_${i%.f*}_${ref3%.f*}_${ref4%.f*}.txt
		      ...
		      wait
		      echo "nloci~mapQ~CHROM~POS" > ${projdir}/alignment_summaries/refgenome_paralogs_${i%.f*}_${ref3%.f*}.txt
		      ...
		      awk '!visited[$0]++' ${projdir}/alignment_summaries/refgenome_paralogs_${i%.f*}_${ref1%.f*}.txt > ${projdir}/alignment_summaries/temp_${i%.f*}.txt
		      mv ${projdir}/alignment_summaries/temp_${i%.f*}.txt ${projdir}/alignment_summaries/refgenome_paralogs_${i%.f*}_${ref1%.f*}.txt
		      echo "nloci~mapQ~CHROM~POS" > ${projdir}/alignment_summaries/refgenome_paralogs_${i%.f*}_${ref4%.f*}.txt
...

		      {
		        ...
		        awk '($3 != "\*")' 2> /dev/null  | awk '($6 != "\*")' 2> /dev/null   | awk '$5 < 10 {$5 = 10}1' | cat ${i%.f*}_heading_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam - | tr ' ' '\t' > ${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam
...

		      {
		        ...
		        awk '($3 != "\*")' 2> /dev/null  | awk '($6 != "\*")' 2> /dev/null   | awk '$5 < 10 {$5 = 10}1' | cat ${i%.f*}_heading_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}.sam - | tr ' ' '\t' > ${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}.sam
...

		      {
		        ...
		        awk '($3 != "\*")' 2> /dev/null  | awk '($6 != "\*")' 2> /dev/null   | awk '$5 < 10 {$5 = 10}1' | cat ${i%.f*}_heading_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}.sam - | tr ' ' '\t' > ${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}.sam
...

		      {
		        ...
		        awk '($3 != "\*")' 2> /dev/null  | awk '($6 != "\*")' 2> /dev/null   | awk '$5 < 10 {$5 = 10}1' | cat ${i%.f*}_heading_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}.sam - | tr ' ' '\t' > ${i%.f*}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}.sam
...

		      {
		        ...
		        awk '($3 != "\*")' 2> /dev/null  | awk '($6 != "\*")' 2> /dev/null   | awk '$5 < 10 {$5 = 10}1' | cat ${i%.f*}_heading_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam - | tr ' ' '\t' > ${i%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam
...

		      {
		        ...
		        awk '($3 != "\*")' 2> /dev/null  | awk '($6 != "\*")' 2> /dev/null   | awk '$5 < 10 {$5 = 10}1' | cat ${i%.f*}_heading_${ref1%.f*}_${ref2%.f*}.sam - | tr ' ' '\t' > ${i%.f*}_${ref1%.f*}_${ref2%.f*}.sam
...

		      {
		        ...
		        awk '($3 != "\*")' 2> /dev/null  | awk '($6 != "\*")' 2> /dev/null   | awk '$5 < 10 {$5 = 10}1' | cat ${i%.f*}_heading_${ref1%.f*}_${ref3%.f*}.sam - | tr ' ' '\t' > ${i%.f*}_${ref1%.f*}_${ref3%.f*}.sam
...

		      {
		        ...
		        awk '($3 != "\*")' 2> /dev/null  | awk '($6 != "\*")' 2> /dev/null   | awk '$5 < 10 {$5 = 10}1' | cat ${i%.f*}_heading_${ref1%.f*}_${ref4%.f*}.sam - | tr ' ' '\t' > ${i%.f*}_${ref1%.f*}_${ref4%.f*}.sam
...

		      {
		        ...
		        awk '($3 != "\*")' 2> /dev/null  | awk '($6 != "\*")' 2> /dev/null   | awk '$5 < 10 {$5 = 10}1' | cat ${i%.f*}_heading_${ref2%.f*}_${ref3%.f*}.sam - | tr ' ' '\t' > ${i%.f*}_${ref2%.f*}_${ref3%.f*}.sam
...

		      {
		        ...
		        awk '($3 != "\*")' 2> /dev/null  | awk '($6 != "\*")' 2> /dev/null   | awk '$5 < 10 {$5 = 10}1' | cat ${i%.f*}_heading_${ref2%.f*}_${ref4%.f*}.sam - | tr ' ' '\t' > ${i%.f*}_${ref2%.f*}_${ref4%.f*}.sam
...

		      {
		        ...
		        awk '($3 != "\*")' 2> /dev/null  | awk '($6 != "\*")' 2> /dev/null   | awk '$5 < 10 {$5 = 10}1' | cat ${i%.f*}_heading_${ref3%.f*}_${ref4%.f*}.sam - | tr ' ' '\t' > ${i%.f*}_${ref3%.f*}_${ref4%.f*}.sam
...

		      {
		        ...
		        awk '($3 != "\*")' 2> /dev/null  | awk '($6 != "\*")' 2> /dev/null   | awk '$5 < 10 {$5 = 10}1' | cat ${i%.f*}_heading_${ref1%.f*}.sam - | tr ' ' '\t' > ${i%.f*}_${ref1%.f*}.sam
...

		      {
		        ...
		        awk '($3 != "\*")' 2> /dev/null  | awk '($6 != "\*")' 2> /dev/null   | awk '$5 < 10 {$5 = 10}1' | cat ${i%.f*}_heading_${ref2%.f*}.sam - | tr ' ' '\t' > ${i%.f*}_${ref2%.f*}.sam
...

		      {
		        ...
		        awk '($3 != "\*")' 2> /dev/null  | awk '($6 != "\*")' 2> /dev/null   | awk '$5 < 10 {$5 = 10}1' | cat ${i%.f*}_heading_${ref3%.f*}.sam - | tr ' ' '\t' > ${i%.f*}_${ref3%.f*}.sam
...

		      {
		        ...
		        awk '($3 != "\*")' 2> /dev/null  | awk '($6 != "\*")' 2> /dev/null   | awk '$5 < 10 {$5 = 10}1' | cat ${i%.f*}_heading_${ref4%.f*}.sam - | tr ' ' '\t' > ${i%.f*}_${ref4%.f*}.sam
	...
	if [[ "${joint_alignment}" -gt 1 ]]; then

		cd ${projdir}/samples
		if [[ "$samples_list" == "samples_list_node_1.txt" ]]; then
      if [[ "$lib_type" =~ "RRS" || "$lib_type" =~ "rrs" ]] && test -f ${projdir}/organize_files_done.txt && test ! -f ${projdir}/compress_done.txt && test ! -f "${projdir}/preprocess/${i%.f*}_redun.sam.gz" && test ! -f "${projdir}/preprocess/${i%.f*}_${ref1%.f*}_precall.bam.bai" && test ! -f "${projdir}/samples/combined_all_sample_reads.fastq.gz"; then
        ...
        if [[ "$nempty" -gt 0 ]]; then
          jalign=1
					for samplechunk in $(ls *_uniq_R1.fasta.gz 2> /dev/null | shuf | awk -v jal=$joint_alignment '{ORS=NR%jal?",":"\n"}1'); do
						cat $(echo $samplechunk | awk '{gsub(/,/," ");}1') | zcat | awk '{print $2}' | awk '!seen[$0] {print} {++seen[$0]}' | \
            awk 'NF' | grep -v '+' | $gzip > combined_all_sample_reads_R1_chunk${jalign}._fasta.gz
						jalign=$((jalign + 1))
					done
					wait
					...
					for samplechunk in $(ls *_uniq_R2.fasta.gz 2> /dev/null | shuf | awk -v jal=$joint_alignment '{ORS=NR%jal?",":"\n"}1'); do
						cat $(echo $samplechunk | awk '{gsub(/,/," ");}1') | zcat | awk '{print $2}' | awk '!seen[$0] {print} {++seen[$0]}' | \
            awk 'NF' | grep -v '+' | $gzip > combined_all_sample_reads_R2_chunk${jalign}.fasta.gz
						jalign=$((jalign + 1))
					done
					wait

          :> combined_all_sample_reads_R1.fasta && gzip combined_all_sample_reads_R1.fasta
          wait
          for i in combined_all_sample_reads_R1_chunk*.fasta.gz; do
            cat <(zcat combined_all_sample_reads_R1.fasta.gz) <(zcat $i) | awk '!seen[$0] {print} {++seen[$0]}' | $gzip > combined_all_sample_reads_R1.tmp.gz
            mv combined_all_sample_reads_R1.tmp.gz combined_all_sample_reads_R1.fasta.gz
            wait
          done
          wait
          :> combined_all_sample_reads_R2.fasta && gzip combined_all_sample_reads_R2.fasta
          wait
          for i in combined_all_sample_reads_R2_chunk*.fasta.gz; do
            cat <(zcat combined_all_sample_reads_R2.fasta.gz) <(zcat $i) | awk '!seen[$0] {print} {++seen[$0]}' | $gzip > combined_all_sample_reads_R2.tmp.gz
            mv combined_all_sample_reads_R2.tmp.gz combined_all_sample_reads_R2.fasta.gz
            wait
          done
          wait
          cat combined_all_sample_reads_R1.fasta.gz combined_all_sample_reads_R2.fasta.gz > combined_all_sample_reads.fasta.gz &&
          rm combined_all_sample_reads_R1.fasta.gz combined_all_sample_reads_R2.fasta.gz
          awk '{print "@"$1"\t"$1"\t+\t"$1}' <(zcat combined_all_sample_reads.fasta.gz) | \
          awk 'BEGIN{OFS="\t"}{gsub(/A|a|C|c|G|g|T|t|N|n/,"I",$4); print}' | awk '{gsub(/\t/,"\n");}1' | $gzip > combined_all_sample_reads.fastq.gz &&
          rm combined_all_sample_reads.fasta.gz
					...
					for samplechunk in $(ls *_uniq_R1.fasta.gz 2> /dev/null | shuf | awk -v jal=$joint_alignment '{ORS=NR%jal?",":"\n"}1'); do
						cat $(echo $samplechunk | awk '{gsub(/,/," ");}1') | zcat | awk '{print $2}' | awk '!seen[$0] {print} {++seen[$0]}' | \
            awk 'NF' | grep -v '+' | $gzip > combined_all_sample_reads_R1_chunk${jalign}.fasta.gz
						jalign=$((jalign + 1))
					done
					wait

          :> combined_all_sample_reads.fasta && gzip combined_all_sample_reads.fasta
          wait
          for i in combined_all_sample_reads_R1_chunk*.fasta.gz; do
            cat <(zcat combined_all_sample_reads.fasta.gz) <(zcat $i) | awk '!seen[$0] {print} {++seen[$0]}' | $gzip > combined_all_sample_reads.tmp.gz
            mv combined_all_sample_reads.tmp.gz combined_all_sample_reads.fasta.gz &&
            awk '{print "@"$1"\t"$1"\t+\t"$1}' <(zcat combined_all_sample_reads.fasta.gz) | \
            awk 'BEGIN{OFS="\t"}{gsub(/A|a|C|c|G|g|T|t|N|n/,"I",$4); print}' | awk '{gsub(/\t/,"\n");}1' | $gzip > combined_all_sample_reads.fastq.gz &&
            rm combined_all_sample_reads.fasta.gz
          done
    ...
    if [[ "$lib_type" =~ "RRS" || "$lib_type" =~ "rrs" ]] && test ! -f ${projdir}/precall_done.txt && test ! -f ${projdir}/alignment_done; then
      if test ! -f ../preprocess/combined_all_sample_reads_redun.sam.gz; then
        $ngm -r ../refgenomes/panref.fasta --qry combined_all_sample_reads.fastq.gz -o ../preprocess/combined_all_sample_reads_redun0.sam -t $threads --min-identity 0 --topn 12 --strata 12 &&
        $java $Xmx2 -XX:ParallelGCThreads=$threads -Djava.io.tmpdir=`pwd`/tmp -jar $picard SortSam I=.../preprocess/combined_all_sample_reads_redun0.sam O=../preprocess/combined_all_sample_reads_redun0.bam  SORT_ORDER=coordinate  VALIDATION_STRINGENCY=LENIENT TMP_DIR=`pwd`/tmp &&
        wait
      fi
    fi
    touch ${projdir}/alignment_done_${samples_list}
      ...
      grep -v '^@' combined_all_sample_reads_redun0.sam | awk '!($3 ~ "\*")' 2> /dev/null | awk '!($6 ~ "\*")' 2> /dev/null | awk -v multilocus=$multilocus -F '\t' 'BEGIN{OFS="\t"} {if ($5==multilocus) {$5=$5+40}}1' | \
			awk '$5 < 10 {$5 = 10}1' | tr ' ' '\t' | cat <(grep '^@' combined_all_sample_reads_redun0.sam) - > combined_all_sample_reads_redun0.tmp && mv combined_all_sample_reads_redun0.tmp combined_all_sample_reads_redun0.sam
      wait
			$java $Xmx2 -XX:ParallelGCThreads=$threads -Djava.io.tmpdir=`pwd`/tmp -jar $picard SortSam I=combined_all_sample_reads_redun0.sam O=combined_all_sample_reads_redun0.bam  SORT_ORDER=coordinate  VALIDATION_STRINGENCY=LENIENT TMP_DIR=`pwd`/tmp && \
			$java $Xmx2 -XX:ParallelGCThreads=$threads -jar $picard BuildBamIndex INPUT=combined_all_sample_reads_redun0.bam VALIDATION_STRINGENCY=LENIENT && \
			$java $Xmx2 -XX:ParallelGCThreads=$threads -jar $picard AddOrReplaceReadGroups I=combined_all_sample_reads_redun0.bam O=combined_all_sample_reads_redun.bam RGLB=combined_all_sample_reads_redun RGPL=illumina RGPU=run RGSM=combined_all_sample_reads_redun VALIDATION_STRINGENCY=LENIENT && \
			$samtools index combined_all_sample_reads_redun.bam &&
			rm combined_all_sample_reads_redun0.bam combined_all_sample_reads_redun0.bai &&
			Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}') &&
			...
			for selchr in $Get2_Chromosome; do (
				if [[ -z "$(ls combined_all_sample_reads_redun_${selchr}.vcf* 2> /dev/null)" ]]; then
					$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -I combined_all_sample_reads_redun.bam -ploidy 2 -O combined_all_sample_reads_redun_${selchr}.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((ploidy * 128)) &&
					wait
				fi
				) &
      ...
      zcat combined_all_sample_reads_redun_*.vcf.gz | grep -v '^#' | awk '{print $1"\t"$2"\t"$10}' | awk '{gsub(/:/,"\t"); print $1"\t"$2"\t"$4}' | \
      awk '{gsub(/,/,"\t"); print $1"\t"$2"\t"$3"\t"$4"\t"$5}' | awk  '$4!=""' | awk '($3>0) + ($4>0) + ($5>0) > 1 {print $1"\t"$2}' | \
      awk '{$2=sprintf("%d00",$2/100)}1' | awk '!seen[$0] {print} {++seen[$0]}' > combined_all_sample_reads_redunRound.vcf
      cat combined_all_sample_reads_redunRound.vcf > combined_all_sample_reads_redun.vcf
			for wint in {100,200,300,400,500}; do
				awk -v wint=$wint '{print $1"\t"$2-wint}' combined_all_sample_reads_redunRound.vcf >> combined_all_sample_reads_redun.vcf
				awk -v wint=$wint '{print $1"\t"$2+wint}' combined_all_sample_reads_redunRound.vcf>> combined_all_sample_reads_redun.vcf
				awk '!seen[$0] {print} {++seen[$0]}' combined_all_sample_reads_redun.vcf > combined_all_sample_reads_redun_temp.vcf
				mv combined_all_sample_reads_redun_temp.vcf combined_all_sample_reads_redun.vcf
				wait
			done
			wait
			rm combined_all_sample_reads_redunRound.vcf combined_all_sample_reads_redun_*.vcf.gz*
			grep '^@' combined_all_sample_reads_redun0.sam > combined_all_sample_reads_redun.sam
			wait
			for selchr in $Get2_Chromosome; do (
				cat combined_all_sample_reads_redun0.sam | grep -v '^@' | awk -v selchr="$selchr" '$3==selchr{print $0}' | awk '{print $4"\t"$0}' | awk '{$1=sprintf("%d00",$1/100)}1' | \
				awk '{print $4":"$1"\t"$0}' | awk '{$2=""}1' | tr ' ' '\t' > combined_all_sample_reads_redun_${selchr}.sam
				cat combined_all_sample_reads_redun.vcf | awk -v selchr="$selchr" '$1==selchr{print $0}' | awk '{print $1":"$2}' > combined_all_sample_reads_redun_${selchr}.vcf
				wait ) &
			...
			wait
			for selchr in $Get2_Chromosome; do (
				awk 'NR==FNR {a[$1]++; next} $1 in a' combined_all_sample_reads_redun_${selchr}.vcf combined_all_sample_reads_redun_${selchr}.sam | \
				awk -F"\t" '{$1=""}1' | awk '{$1=$1};1' | tr ' ' '\t' > combined_all_sample_reads_redun_${selchr}_pmorph.sam
				wait ) &
				if [[ $(jobs -r -p | wc -l) -ge $N ]]; then
					wait
				fi
			...
			wait
      cat combined_all_sample_reads_redun_*_pmorph.sam >> combined_all_sample_reads_redun.sam
      wait
			rm combined_all_sample_reads_redun_*.sam combined_all_sample_reads_redun_*.vcf
...
awk 'NR==FNR {a[$1]++; next} $1 in a' <(zcat ../samples/${i%.f*}_uniq*.fasta.gz | awk '{print $2}') <(zcat combined_all_sample_reads_redun.sam.gz | grep -v '^@') | \
awk 'NR==FNR{a[$2]=$1; next} ($1 in a){print a[$1]"\t"$0}' <(zcat ../samples/${i%.f*}_uniq*.fasta.gz | awk '{gsub(/>/,"");}1') - | awk '{$2=""}1' | awk '{$1=$1};1' | \
tr ' ' '\t' | cat <(zcat combined_all_sample_reads_redun.sam.gz | grep '^@') - | gzip > ${i%.f*}_redun.sam.gz
			fi
      wait
...
main () {
	...
	if [[ "$samples_list" == "samples_list_node_1.txt" ]]; then
	    ...
	    j=-I; input=""; k=""
	    for i in $(ls *_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_precall.bam 2> /dev/null); do
	      k="${j} ${i}"; input="${input} ${k}"
	    done
	    Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}' )
	    if [[ ! -z "$Exclude_Chromosome" ]]; then
	    ...
	    if [[ -z "$Get_Chromosome" ]]; then
	      ...
	      echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2":1-"$3}' > ${projdir}/refgenomes/panref.list
	    ...
	    j=-I; input=""; k=""
	    for i in $(ls *_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_precall.bam 2> /dev/null); do
	    	k="${j} ${i}"; input="${input} ${k}"
	    done
	    calcploidy=$(($ploidy_ref1 + $ploidy_ref2 + $ploidy_ref3))
	    Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}' | awk -v pat1=${ref1%.f*} -v pat2=${ref2%.f*} -v pat3=${ref3%.f*} 'pat1 || pat2 || pat3')
	    if [[ ! -z "$Exclude_Chromosome" ]]; then
	    	for i in $(echo "$Exclude_Chromosome" | tr ',' '\n'); do
	    		Get2_Chromosome=$(echo $Get2_Chromosome | awk -v i=$i '{gsub(i,"");}1')
	    	done
	    ...
	    j=-I; input=""; k=""
	    for i in $(ls *_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}_precall.bam 2> /dev/null); do
	    	k="${j} ${i}"; input="${input} ${k}"
	    done
	    calcploidy=$(($ploidy_ref1 + $ploidy_ref2 + $ploidy_ref4))
	    Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}' | awk -v pat1=${ref1%.f*} -v pat2=${ref2%.f*} -v pat3=${ref4%.f*} 'pat1 || pat2 || pat3')
	    if [[ ! -z "$Exclude_Chromosome" ]]; then
	    	for i in $(echo "$Exclude_Chromosome" | tr ',' '\n'); do
	    		Get2_Chromosome=$(echo $Get2_Chromosome | awk -v i=$i '{gsub(i,"");}1')
	    	done
	    ...
	    j=-I; input=""; k=""
	    for i in $(ls *_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}_precall.bam 2> /dev/null); do
	    	k="${j} ${i}"; input="${input} ${k}"
	    done
	    calcploidy=$(($ploidy_ref1 + $ploidy_ref3 + $ploidy_ref4))
	    Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}' | awk -v pat1=${ref1%.f*} -v pat2=${ref3%.f*} -v pat3=${ref4%.f*} 'pat1 || pat2 || pat3')
	    if [[ ! -z "$Exclude_Chromosome" ]]; then
	    	for i in $(echo "$Exclude_Chromosome" | tr ',' '\n'); do
	    		Get2_Chromosome=$(echo $Get2_Chromosome | awk -v i=$i '{gsub(i,"");}1')
	    	done
	    ...
	    j=-I; input=""; k=""
	    for i in $(ls *_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_precall.bam 2> /dev/null); do
	    	k="${j} ${i}"; input="${input} ${k}"
	    done
	    calcploidy=$(($ploidy_ref2 + $ploidy_ref3 + $ploidy_ref4))
	    Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}' | awk -v pat1=${ref2%.f*} -v pat2=${ref3%.f*} -v pat3=${ref4%.f*} 'pat1 || pat2 || pat3')
	    if [[ ! -z "$Exclude_Chromosome" ]]; then
	    	for i in $(echo "$Exclude_Chromosome" | tr ',' '\n'); do
	    		Get2_Chromosome=$(echo $Get2_Chromosome | awk -v i=$i '{gsub(i,"");}1')
	    	done
	    ...
	    j=-I; input=""; k=""
	    for i in $(ls *_${ref1%.f*}_${ref2%.f*}_precall.bam 2> /dev/null); do
	    	k="${j} ${i}"; input="${input} ${k}"
	    done
	    calcploidy=$(($ploidy_ref1 + $ploidy_ref2))
	    Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}' | awk -v pat1=${ref1%.f*} -v pat2=${ref2%.f*} 'pat1 || pat2')
	    if [[ ! -z "$Exclude_Chromosome" ]]; then
	    	for i in $(echo "$Exclude_Chromosome" | tr ',' '\n'); do
	    		Get2_Chromosome=$(echo $Get2_Chromosome | awk -v i=$i '{gsub(i,"");}1')
	    	done
	    ...
	    j=-I; input=""; k=""
	    for i in $(ls *_${ref1%.f*}_${ref3%.f*}_precall.bam 2> /dev/null); do
	    	k="${j} ${i}"; input="${input} ${k}"
	    done
	    calcploidy=$(($ploidy_ref1 + $ploidy_ref3))
	    Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}' | awk -v pat1=${ref1%.f*} -v pat2=${ref3%.f*} 'pat1 || pat2')
	    if [[ ! -z "$Exclude_Chromosome" ]]; then
	    	for i in $(echo "$Exclude_Chromosome" | tr ',' '\n'); do
	    		Get2_Chromosome=$(echo $Get2_Chromosome | awk -v i=$i '{gsub(i,"");}1')
	    	done
	    ...
	    j=-I; input=""; k=""
	    for i in $(ls *_${ref1%.f*}_${ref4%.f*}_precall.bam 2> /dev/null); do
	    	k="${j} ${i}"; input="${input} ${k}"
	    done
	    calcploidy=$(($ploidy_ref1 + $ploidy_ref4))
	    Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}' | awk -v pat1=${ref1%.f*} -v pat2=${ref4%.f*} 'pat1 || pat2')
	    if [[ ! -z "$Exclude_Chromosome" ]]; then
	    	for i in $(echo "$Exclude_Chromosome" | tr ',' '\n'); do
	    		Get2_Chromosome=$(echo $Get2_Chromosome | awk -v i=$i '{gsub(i,"");}1')
	    	done
	    ...
	    j=-I; input=""; k=""
	    for i in $(ls *_${ref2%.f*}_${ref4%.f*}_precall.bam 2> /dev/null); do
	    	k="${j} ${i}"; input="${input} ${k}"
	    done
	    calcploidy=$(($ploidy_ref2 + $ploidy_ref4))
	    Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}' | awk -v pat1=${ref2%.f*} -v pat2=${ref4%.f*} 'pat1 || pat2')
	    if [[ ! -z "$Exclude_Chromosome" ]]; then
	    	for i in $(echo "$Exclude_Chromosome" | tr ',' '\n'); do
	    		Get2_Chromosome=$(echo $Get2_Chromosome | awk -v i=$i '{gsub(i,"");}1')
	    	done
	    ...
	    j=-I; input=""; k=""
	    for i in $(ls *_${ref3%.f*}_${ref4%.f*}_precall.bam 2> /dev/null); do
	    	k="${j} ${i}"; input="${input} ${k}"
	    done
	    calcploidy=$(($ploidy_ref3 + $ploidy_ref4))
	    Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}' | awk -v pat1=${ref3%.f*} -v pat2=${ref4%.f*} 'pat1 || pat2')
	    if [[ ! -z "$Exclude_Chromosome" ]]; then
	    	for i in $(echo "$Exclude_Chromosome" | tr ',' '\n'); do
	    		Get2_Chromosome=$(echo $Get2_Chromosome | awk -v i=$i '{gsub(i,"");}1')
	    	done
	    ...
	    mv *_${ref3%.f*}_${ref4%.f*}_precall* ./processed/
		  ...
		  j=-I; input=""; k=""
		  for i in $(ls *_${ref1%.f*}_precall.bam 2> /dev/null); do
		    k="${j} ${i}"; input="${input} ${k}"
		  done
		  Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}'| awk -v pat=${ref1%.f*} '$0 ~ pat' )
			if [[ ! -z "$Exclude_Chromosome" ]]; then
				for i in $(echo "$Exclude_Chromosome" | tr ',' '\n'); do
					Get2_Chromosome=$(echo $Get2_Chromosome | awk -v i=$i '{gsub(i,"");}1')
				done
		  ...
		  if [[ -z "$Get_Chromosome" ]]; then
		    ...
		    echo $Get_Chromosome | tr ',' '\n' | awk -v pat=${ref1%.f*} '$0 ~ pat' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2":1-"$3}' > ${projdir}/refgenomes/panref.list
		  ...
		  j=-I; input=""; k=""
		  for i in $(ls *_${ref2%.f*}_precall.bam 2> /dev/null); do
		    k="${j} ${i}"; input="${input} ${k}"
		  done
		  Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}'| awk -v pat=${ref2%.f*} '$0 ~ pat' )
			if [[ ! -z "$Exclude_Chromosome" ]]; then
				for i in $(echo "$Exclude_Chromosome" | tr ',' '\n'); do
					Get2_Chromosome=$(echo $Get2_Chromosome | awk -v i=$i '{gsub(i,"");}1')
				done
		  ...
		  if [[ -z "$Get_Chromosome" ]]; then
		    ...
		    echo $Get_Chromosome | tr ',' '\n' | awk -v pat=${ref2%.f*} '$0 ~ pat' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2":1-"$3}' > ${projdir}/refgenomes/panref.list
	    ...
	    ######################
		  ...
		  j=-I; input=""; k=""
		  for i in $(ls *_${ref3%.f*}_precall.bam 2> /dev/null); do
		    k="${j} ${i}"; input="${input} ${k}"
		  done
		  Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}'| awk -v pat=${ref3%.f*} '$0 ~ pat' )
			if [[ ! -z "$Exclude_Chromosome" ]]; then
				for i in $(echo "$Exclude_Chromosome" | tr ',' '\n'); do
					Get2_Chromosome=$(echo $Get2_Chromosome | awk -v i=$i '{gsub(i,"");}1')
				done
		  ...
		  if [[ -z "$Get_Chromosome" ]]; then
		    ...
		    echo $Get_Chromosome | tr ',' '\n' | awk -v pat=${ref3%.f*} '$0 ~ pat' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2":1-"$3}' > ${projdir}/refgenomes/panref.list
	    ...
	    ######################
		  ...
		  j=-I; input=""; k=""
		  for i in $(ls *_${ref4%.f*}_precall.bam 2> /dev/null); do
		    k="${j} ${i}"; input="${input} ${k}"
		  done
		  Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}'| awk -v pat=${ref4%.f*} '$0 ~ pat' )
			if [[ ! -z "$Exclude_Chromosome" ]]; then
				for i in $(echo "$Exclude_Chromosome" | tr ',' '\n'); do
					Get2_Chromosome=$(echo $Get2_Chromosome | awk -v i=$i '{gsub(i,"");}1')
				done
		  ...
		  if [[ -z "$Get_Chromosome" ]]; then
		    ...
		    echo $Get_Chromosome | tr ',' '\n' | awk -v pat=${ref4%.f*} '$0 ~ pat' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2":1-"$3}' > ${projdir}/refgenomes/panref.list
    ...
    for i in $(cat ${projdir}/${samples_list} ); do (
    	...
    	if test ! -f "${projdir}/snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${ploidy}x_raw.vcf.gz"; then
    		if test ! -f "${projdir}/snpcall/${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.g.vcf.gz"; then
    			if [[ -z "$Get_Chromosome" ]]; then
    				$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -I ${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_precall.bam -ploidy $ploidy -O ../snpcall/${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((ploidy * maxHaplotype)) &&
    				wait
    			else
    				echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ../refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2":1-"$3}' > ../refgenomes/panref.list
    				$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -L ../refgenomes/panref.list -I ${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_precall.bam -ploidy $ploidy -O ../snpcall/${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((ploidy * maxHaplotype)) &&
    				wait
    			fi
    ...
    if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${ploidy}x_raw.vcf*; then
    	...
    	if [[ $call1234 == $nodes ]]; then
    		...
    		for dir in cohorts*/; do
    			cd $dir
    			j=--variant; input=""; k=""
    			for i in $(ls *_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.g.vcf.gz 2> /dev/null); do
    				k="${j} ${i}"; input="${input} ${k}"
    			done
    			if [[ -z "$Get_Chromosome" ]]; then
    				Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}' )
    			...
    			for selchr in $Get2_Chromosome; do
    				$GATK --java-options "$Xmxp -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${ploidy}x_${selchr}_raw
						wait
    			done
    			for selchr in $Get2_Chromosome; do (
    				if test ! -f "${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${ploidy}x_${selchr}_raw.vcf.gz"; then
    					$GATK --java-options "$Xmx1 -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${ploidy}x_${selchr}_raw -O ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${ploidy}x_${selchr}_raw.hold.vcf.gz && \
    ...
    for i in $(cat ${projdir}/${samples_list} ); do (
    	...
    	if test ! -f "${projdir}/snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_raw.vcf.gz"; then
    		if test ! -f "${projdir}/snpcall/${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}.g.vcf.gz"; then
    			if [[ -z "$Get_Chromosome" ]]; then
    				$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -I ${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_precall.bam -ploidy $calcploidy -O ../snpcall/${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			else
    				echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ../refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2":1-"$3}' > ../refgenomes/panref.list
    				$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -L ../refgenomes/panref.list -I ${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_precall.bam -ploidy $calcploidy -O ../snpcall/${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			fi
    ...
    if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_raw.vcf*; then
    	...
    	if [[ $call123 == $nodes ]]; then
    		...
    		for dir in cohorts*/; do
    			cd $dir
    			j=--variant; input=""; k=""
    			for i in $(ls *_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}.g.vcf.gz 2> /dev/null); do
    				k="${j} ${i}"; input="${input} ${k}"
    			done
    			if [[ -z "$Get_Chromosome" ]]; then
    				Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}' )
    			...
    			for selchr in $Get2_Chromosome; do
    				$GATK --java-options "$Xmxp -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw
						wait
    			done
    			for selchr in $Get2_Chromosome; do (
    				if test ! -f "${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"; then
    					$GATK --java-options "$Xmx1 -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
    ...
    for i in $(cat ${projdir}/${samples_list} ); do (
    	...
    	if test ! -f "${projdir}/snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf.gz"; then
    		if test ! -f "${projdir}/snpcall/${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}.g.vcf.gz"; then
    			if [[ -z "$Get_Chromosome" ]]; then
    				$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -I ${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}_precall.bam -ploidy $calcploidy -O ../snpcall/${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			else
    				echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ../refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2":1-"$3}' > ../refgenomes/panref.list
    				$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -L ../refgenomes/panref.list -I ${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}_precall.bam -ploidy $calcploidy -O ../snpcall/${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			fi
    ...
    if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf*; then
    	...
    	if [[ $call124 == $nodes ]]; then
    		...
    		for dir in cohorts*/; do
    			cd $dir
    			j=--variant; input=""; k=""
    			for i in $(ls *_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}.g.vcf.gz 2> /dev/null); do
    				k="${j} ${i}"; input="${input} ${k}"
    			done
    			if [[ -z "$Get_Chromosome" ]]; then
    				Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}' )
    			...
    			for selchr in $Get2_Chromosome; do
    				$GATK --java-options "$Xmxp -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw
						wait
    			done
    			for selchr in $Get2_Chromosome; do (
    				if test ! -f "${pop}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"; then
    					$GATK --java-options "$Xmx1 -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
    ...
    for i in $(cat ${projdir}/${samples_list} ); do (
    	...
    	if test ! -f "${projdir}/snpcall/${pop}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf.gz"; then
    		if test ! -f "${projdir}/snpcall/${i%.f*}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}.g.vcf.gz"; then
    			if [[ -z "$Get_Chromosome" ]]; then
    				$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -I ${i%.f*}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}_precall.bam -ploidy $calcploidy -O ../snpcall/${i%.f*}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			else
    				echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ../refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2":1-"$3}' > ../refgenomes/panref.list
    				$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -L ../refgenomes/panref.list -I ${i%.f*}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}_precall.bam -ploidy $calcploidy -O ../snpcall/${i%.f*}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			fi
    ...
    if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf*; then
    	...
    	if [[ $call134 == $nodes ]]; then
    		...
    		for dir in cohorts*/; do
    			cd $dir
    			j=--variant; input=""; k=""
    			for i in $(ls *_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}.g.vcf.gz 2> /dev/null); do
    				k="${j} ${i}"; input="${input} ${k}"
    			done
    			if [[ -z "$Get_Chromosome" ]]; then
    				Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}' )
    			...
    			for selchr in $Get2_Chromosome; do
    				$GATK --java-options "$Xmxp -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw
						wait
    			done
    			for selchr in $Get2_Chromosome; do (
    				if test ! -f "${pop}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"; then
    					$GATK --java-options "$Xmx1 -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
    ...
    for i in $(cat ${projdir}/${samples_list} ); do (
    	...
    	if test ! -f "${projdir}/snpcall/${pop}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf.gz"; then
    		if test ! -f "${projdir}/snpcall/${i%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.g.vcf.gz"; then
    			if [[ -z "$Get_Chromosome" ]]; then
    				$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -I ${i%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_precall.bam -ploidy $calcploidy -O ../snpcall/${i%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			else
    				echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ../refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2":1-"$3}' > ../refgenomes/panref.list
    				$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -L ../refgenomes/panref.list -I ${i%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_precall.bam -ploidy $calcploidy -O ../snpcall/${i%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			fi
    ...
    if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf*; then
    	...
    	if [[ $call234 == $nodes ]]; then
    		...
    		for dir in cohorts*/; do
    			cd $dir
    			j=--variant; input=""; k=""
    			for i in $(ls *_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.g.vcf.gz 2> /dev/null); do
    				k="${j} ${i}"; input="${input} ${k}"
    			done
    			if [[ -z "$Get_Chromosome" ]]; then
    				Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}' )
    			...
    			for selchr in $Get2_Chromosome; do
    				$GATK --java-options "$Xmxp -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw
						wait
    			done
    			for selchr in $Get2_Chromosome; do (
    				if test ! -f "${pop}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"; then
    					$GATK --java-options "$Xmx1 -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
    ...
    for i in $(cat ${projdir}/${samples_list} ); do (
    	...
    	if test ! -f "${projdir}/snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${calcploidy}x_raw.vcf.gz"; then
    		if test ! -f "${projdir}/snpcall/${i%.f*}_${ref1%.f*}_${ref2%.f*}.g.vcf.gz"; then
    			if [[ -z "$Get_Chromosome" ]]; then
    				$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -I ${i%.f*}_${ref1%.f*}_${ref2%.f*}_precall.bam -ploidy $calcploidy -O ../snpcall/${i%.f*}_${ref1%.f*}_${ref2%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			else
    				echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ../refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2":1-"$3}' > ../refgenomes/panref.list
    				$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -L ../refgenomes/panref.list -I ${i%.f*}_${ref1%.f*}_${ref2%.f*}_precall.bam -ploidy $calcploidy -O ../snpcall/${i%.f*}_${ref1%.f*}_${ref2%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			fi
    ...
    if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${calcploidy}x_raw.vcf*; then
    	...
    	if [[ $call12 == $nodes ]]; then
    		...
    		for dir in cohorts*/; do
    			cd $dir
    			j=--variant; input=""; k=""
    			for i in $(ls *_${ref1%.f*}_${ref2%.f*}.g.vcf.gz 2> /dev/null); do
    				k="${j} ${i}"; input="${input} ${k}"
    			done
    			if [[ -z "$Get_Chromosome" ]]; then
    				Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}' )
    			...
    			for selchr in $Get2_Chromosome; do
    				$GATK --java-options "$Xmxp -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref1%.f*}_${ref2%.f*}_${calcploidy}x_${selchr}_raw
						wait
    			done
    			for selchr in $Get2_Chromosome; do (
    				if test ! -f "${pop}_${ref1%.f*}_${ref2%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"; then
    					$GATK --java-options "$Xmx1 -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref1%.f*}_${ref2%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref1%.f*}_${ref2%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
    ...
    for i in $(cat ${projdir}/${samples_list} ); do (
    	...
    	if test ! -f "${projdir}/snpcall/${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_raw.vcf.gz"; then
    		if test ! -f "${projdir}/snpcall/${i%.f*}_${ref1%.f*}_${ref3%.f*}.g.vcf.gz"; then
    			if [[ -z "$Get_Chromosome" ]]; then
    				$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -I ${i%.f*}_${ref1%.f*}_${ref3%.f*}_precall.bam -ploidy $calcploidy -O ../snpcall/${i%.f*}_${ref1%.f*}_${ref3%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			else
    				echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ../refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2":1-"$3}' > ../refgenomes/panref.list
    				$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -L ../refgenomes/panref.list -I ${i%.f*}_${ref1%.f*}_${ref3%.f*}_precall.bam -ploidy $calcploidy -O ../snpcall/${i%.f*}_${ref1%.f*}_${ref3%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			fi
    ...
    if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_raw.vcf*; then
    	...
    	if [[ $call13 == $nodes ]]; then
    		...
    		for dir in cohorts*/; do
    			cd $dir
    			j=--variant; input=""; k=""
    			for i in $(ls *_${ref1%.f*}_${ref3%.f*}.g.vcf.gz 2> /dev/null); do
    				k="${j} ${i}"; input="${input} ${k}"
    			done
    			if [[ -z "$Get_Chromosome" ]]; then
    				Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}' )
    			...
    			for selchr in $Get2_Chromosome; do
    				$GATK --java-options "$Xmxp -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw
						wait
    			done
    			for selchr in $Get2_Chromosome; do (
    				if test ! -f "${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"; then
    					$GATK --java-options "$Xmx1 -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref1%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
    ...
    for i in $(cat ${projdir}/${samples_list} ); do (
    	...
    	if test ! -f "${projdir}/snpcall/${pop}_${ref1%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf.gz"; then
    		if test ! -f "${projdir}/snpcall/${i%.f*}_${ref1%.f*}_${ref4%.f*}.g.vcf.gz"; then
    			if [[ -z "$Get_Chromosome" ]]; then
    				$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -I ${i%.f*}_${ref1%.f*}_${ref4%.f*}_precall.bam -ploidy $calcploidy -O ../snpcall/${i%.f*}_${ref1%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			else
    				echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ../refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2":1-"$3}' > ../refgenomes/panref.list
    				$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -L ../refgenomes/panref.list -I ${i%.f*}_${ref1%.f*}_${ref4%.f*}_precall.bam -ploidy $calcploidy -O ../snpcall/${i%.f*}_${ref1%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			fi
    ...
    if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf*; then
    	...
    	if [[ $call14 == $nodes ]]; then
    		...
    		for dir in cohorts*/; do
    			cd $dir
    			j=--variant; input=""; k=""
    			for i in $(ls *_${ref1%.f*}_${ref4%.f*}.g.vcf.gz 2> /dev/null); do
    				k="${j} ${i}"; input="${input} ${k}"
    			done
    			if [[ -z "$Get_Chromosome" ]]; then
    				Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}' )
    			...
    			for selchr in $Get2_Chromosome; do
    				$GATK --java-options "$Xmxp -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref1%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw
						wait
    			done
    			for selchr in $Get2_Chromosome; do (
    				if test ! -f "${pop}_${ref1%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"; then
    					$GATK --java-options "$Xmx1 -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref1%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref1%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
    ...
    for i in $(cat ${projdir}/${samples_list} ); do (
    	...
    	if test ! -f "${projdir}/snpcall/${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_raw.vcf.gz"; then
    		if test ! -f "${projdir}/snpcall/${i%.f*}_${ref2%.f*}_${ref3%.f*}.g.vcf.gz"; then
    			if [[ -z "$Get_Chromosome" ]]; then
    				$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -I ${i%.f*}_${ref2%.f*}_${ref3%.f*}_precall.bam -ploidy $calcploidy -O ../snpcall/${i%.f*}_${ref2%.f*}_${ref3%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			else
    				echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ../refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2":1-"$3}' > ../refgenomes/panref.list
    				$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -L ../refgenomes/panref.list -I "${i%.f*}_${ref2%.f*}_${ref3%.f*}_precall.bam" -ploidy $calcploidy -O ../snpcall/${i%.f*}_${ref2%.f*}_${ref3%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			fi
    ...
    if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_raw.vcf*; then
    	...
    	if [[ $call23 == $nodes ]]; then
    		...
    		for dir in cohorts*/; do
    			cd $dir
    			j=--variant; input=""; k=""
    			for i in $(ls *_${ref2%.f*}_${ref3%.f*}.g.vcf.gz 2> /dev/null); do
    				k="${j} ${i}"; input="${input} ${k}"
    			done
    			if [[ -z "$Get_Chromosome" ]]; then
    				Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}' )
    			...
    			for selchr in $Get2_Chromosome; do
    				$GATK --java-options "$Xmxp -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw
						wait
    			done
    			for selchr in $Get2_Chromosome; do (
    				if test ! -f "${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"; then
    					$GATK --java-options "$Xmx1 -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
    ...
    for i in $(cat ${projdir}/${samples_list} ); do (
    	...
    	if test ! -f "${projdir}/snpcall/${pop}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf.gz"; then
    		if test ! -f "${projdir}/snpcall/${i%.f*}_${ref2%.f*}_${ref4%.f*}.g.vcf.gz"; then
    			if [[ -z "$Get_Chromosome" ]]; then
    				$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -I ${i%.f*}_${ref2%.f*}_${ref4%.f*}_precall.bam -ploidy $calcploidy -O ../snpcall/${i%.f*}_${ref2%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			else
    				echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ../refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2":1-"$3}' > ../refgenomes/panref.list
    				$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -L ../refgenomes/panref.list -I ${i%.f*}_${ref2%.f*}_${ref4%.f*}_precall.bam -ploidy $calcploidy -O ../snpcall/${i%.f*}_${ref2%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			fi
    ...
    if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf*; then
    	...
    	if [[ $call24 == $nodes ]]; then
    		...
    		for dir in cohorts*/; do
    			cd $dir
    			j=--variant; input=""; k=""
    			for i in $(ls *_${ref2%.f*}_${ref4%.f*}.g.vcf.gz 2> /dev/null); do
    				k="${j} ${i}"; input="${input} ${k}"
    			done
    			if [[ -z "$Get_Chromosome" ]]; then
    				Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}' )
    			...
    			for selchr in $Get2_Chromosome; do (
    				$GATK --java-options "$Xmxp -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw ) &
						if [[ $(jobs -r -p | wc -l) -ge $gN ]]; then
							wait
						fi
    			done
    			for selchr in $Get2_Chromosome; do (
    				if test ! -f "${pop}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"; then
    					$GATK --java-options "$Xmx1 -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
    ...
    for i in $(cat ${projdir}/${samples_list} ); do (
    	...
    	if test ! -f "${projdir}/snpcall/${pop}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf.gz"; then
    		if test ! -f "${projdir}/snpcall/${i%.f*}_${ref3%.f*}_${ref4%.f*}.g.vcf.gz"; then
    			if [[ -z "$Get_Chromosome" ]]; then
    				$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -I ${i%.f*}_${ref3%.f*}_${ref4%.f*}_precall.bam -ploidy $calcploidy -O ../snpcall/${i%.f*}_${ref3%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			else
    				echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ../refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2":1-"$3}' > ../refgenomes/panref.list
    				$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -L ../refgenomes/panref.list -I ${i%.f*}_${ref3%.f*}_${ref4%.f*}_precall.bam -ploidy $calcploidy -O ../snpcall/${i%.f*}_${ref3%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			fi
    ...
    if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf*; then
    	...
    	if [[ $call34 == $nodes ]]; then
    		...
    		for dir in cohorts*/; do
    			cd $dir
    			j=--variant; input=""; k=""
    			for i in $(ls *_${ref3%.f*}_${ref4%.f*}.g.vcf.gz 2> /dev/null); do
    				k="${j} ${i}"; input="${input} ${k}"
    			done
    			if [[ -z "$Get_Chromosome" ]]; then
    				Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}' )
    			...
    			for selchr in $Get2_Chromosome; do (
    				$GATK --java-options "$Xmxp -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw ) &
						if [[ $(jobs -r -p | wc -l) -ge $gN ]]; then
							wait
						fi
    			done
    			for selchr in $Get2_Chromosome; do (
    				if test ! -f "${pop}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz"; then
    					$GATK --java-options "$Xmx1 -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw -O ${pop}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.hold.vcf.gz && \
				...
				if test ! -f "${projdir}/snpcall/${pop}_${ref1%.f*}_${ploidy_ref1}x_raw.vcf.gz"; then
					if test ! -f ${projdir}/snpcall/${i%.f*}_${ref1%.f*}.g.vcf.gz; then
						if [[ -z "$Get_Chromosome" ]]; then
						  ...
						  echo $Get_Chromosome | tr ',' '\n' | awk -v pat=${ref1%.f*} '$0 ~ pat' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ../refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2":1-"$3}' > ../refgenomes/panref.list
			...
			if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f $${projdir}/snpcall/{pop}_${ref1%.f*}_${ploidy_ref1}x_raw.vcf*; then
			  ...
			  if [[ $call1 == $nodes ]]; then
					...
					for dir in cohorts*/; do
						cd $dir
						j=--variant; input=""; k=""
						for i in $(ls *_${ref1%.f*}.g.vcf.gz 2> /dev/null); do
							k="${j} ${i}"; input="${input} ${k}"
						done
						if [[ -z "$Get_Chromosome" ]]; then
							Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}'| awk -v pat=${ref1%.f*} '$0 ~ pat' )
						...
						for selchr in $Get2_Chromosome; do
							$GATK --java-options "$Xmxp -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref1%.f*}_${ploidy_ref1}x_${selchr}_raw
							wait
						done
						for selchr in $Get2_Chromosome; do (
							if test ! -f "${pop}_${ref1%.f*}_${ploidy_ref1}x_${selchr}_raw.vcf.gz"; then
								$GATK --java-options "$Xmx1 -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref1%.f*}_${ploidy_ref1}x_${selchr}_raw -O ${pop}_${ref1%.f*}_${ploidy_ref1}x_${selchr}_raw.hold.vcf.gz && \
			...
			if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f ${projdir}/snpcall/${pop}_${ref2%.f*}_${ploidy_ref2}x_raw.vcf*; then
			  ...
			  if [[ $call2 == $nodes ]]; then
					...
					for dir in cohorts*/; do
						...
						for selchr in $Get2_Chromosome; do
							$GATK --java-options "$Xmxp -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref2%.f*}_${ploidy_ref2}x_${selchr}_raw
							wait
						done
						for selchr in $Get2_Chromosome; do (
							if test ! -f "${pop}_${ref2%.f*}_${ploidy_ref2}x_${selchr}_raw.vcf.gz"; then
								$GATK --java-options "$Xmx1 -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref2%.f*}_${ploidy_ref2}x_${selchr}_raw -O ${pop}_${ref2%.f*}_${ploidy_ref2}x_${selchr}_raw.hold.vcf.gz && \
			...
			for i in $(cat ${projdir}/${samples_list} ); do (
				...
				if test ! -f "${projdir}/snpcall/${pop}_${ref3%.f*}_${ploidy_ref3}x_raw.vcf.gz"; then
					if test ! -f ${projdir}/snpcall/${i%.f*}_${ref3%.f*}.g.vcf.gz; then
						if [[ -z "$Get_Chromosome" ]]; then
							$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads"  HaplotypeCaller -R ../refgenomes/panref.fasta -I ${i%.f*}_${ref3%.f*}_precall.bam -ploidy $ploidy_ref3 -O ../snpcall/${i%.f*}_${ref3%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((ploidy_ref3 * maxHaplotype)) &&
							wait
						else
						  echo $Get_Chromosome | tr ',' '\n' | awk -v pat=${ref3%.f*} '$0 ~ pat' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ../refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2":1-"$3}' > ../refgenomes/panref.list
							$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads"  HaplotypeCaller -R ../refgenomes/panref.fasta -L ../refgenomes/panref.list -I ${i%.f*}_${ref3%.f*}_precall.bam -ploidy $ploidy_ref3 -O ../snpcall/${i%.f*}_${ref3%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((ploidy_ref3 * maxHaplotype)) &&
							wait
						fi
			...
			if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f $${projdir}/snpcall/{pop}_${ref3%.f*}_${ploidy_ref3}x_raw.vcf*; then
			  ...
			  if [[ $call3 == $nodes ]]; then
					...
					for dir in cohorts*/; do
						...
						for selchr in $Get2_Chromosome; do
							$GATK --java-options "$Xmxp -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref3%.f*}_${ploidy_ref3}x_${selchr}_raw
							wait
						done
						for selchr in $Get2_Chromosome; do (
							if test ! -f "${pop}_${ref3%.f*}_${ploidy_ref3}x_${selchr}_raw.vcf.gz"; then
								$GATK --java-options "$Xmx1 -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref3%.f*}_${ploidy_ref3}x_${selchr}_raw -O ${pop}_${ref3%.f*}_${ploidy_ref3}x_${selchr}_raw.hold.vcf.gz && \
  			...
  			for i in $(cat ${projdir}/${samples_list} ); do (
  				...
  				if test ! -f "${projdir}/snpcall/${pop}_${ref4%.f*}_${ploidy_ref4}x_raw.vcf.gz"; then
  					if test ! -f ${projdir}/snpcall/${i%.f*}_${ref4%.f*}.g.vcf.gz; then
  						if [[ -z "$Get_Chromosome" ]]; then
  							$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads"  HaplotypeCaller -R ../refgenomes/panref.fasta -I ${i%.f*}_${ref4%.f*}_precall.bam -ploidy $ploidy_ref4 -O ../snpcall/${i%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((ploidy_ref4 * maxHaplotype)) &&
  							wait
  						else
  						  echo $Get_Chromosome | tr ',' '\n' | awk -v pat=${ref4%.f*} '$0 ~ pat' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ../refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2":1-"$3}' > ../refgenomes/panref.list
  							$GATK --java-options "$Xmxg -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads"  HaplotypeCaller -R ../refgenomes/panref.fasta -L ../refgenomes/panref.list -I ${i%.f*}_${ref4%.f*}_precall.bam -ploidy $ploidy_ref4 -O ../snpcall/${i%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 10 --max-num-haplotypes-in-population $((ploidy_ref4 * maxHaplotype)) &&
  							wait
  						fi
  			...
  			if [[ "$samples_list" == "samples_list_node_1.txt" ]] && test ! -f $${projdir}/snpcall/{pop}_${ref4%.f*}_${ploidy_ref4}x_raw.vcf*; then
  			  ...
  			  if [[ $call4 == $nodes ]]; then
  					...
  					for dir in cohorts*/; do
  						cd $dir
  						j=--variant; input=""; k=""
  						for i in $(ls *_${ref4%.f*}.g.vcf.gz 2> /dev/null); do
  							k="${j} ${i}"; input="${input} ${k}"
  						done
  						if [[ -z "$Get_Chromosome" ]]; then
  							Get2_Chromosome=$(awk 'NR>1{print $2,"\t",$3}' ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $0}' | sort -k2,2 -n | awk '{print $1}'| awk -v pat=${ref4%.f*} '$0 ~ pat' )
  						...
  						for selchr in $Get2_Chromosome; do
  							$GATK --java-options "$Xmxp -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" GenomicsDBImport ${input} -L ${selchr} --genomicsdb-workspace-path ${pop}_${ref4%.f*}_${ploidy_ref4}x_${selchr}_raw
								wait
  						done
  						for selchr in $Get2_Chromosome; do (
  							if test ! -f "${pop}_${ref4%.f*}_${ploidy_ref4}x_${selchr}_raw.vcf.gz"; then
  								$GATK --java-options "$Xmx1 -Djava.io.tmpdir=${projdir}/snpcall/tmp -XX:+UseParallelGC -XX:ParallelGCThreads=$loopthreads"  GenotypeGVCFs -R ${projdir}/refgenomes/panref.fasta -L ${selchr} -V gendb://${pop}_${ref4%.f*}_${ploidy_ref4}x_${selchr}_raw -O ${pop}_${ref4%.f*}_${ploidy_ref4}x_${selchr}_raw.hold.vcf.gz && \
...
if [[ -z "$p1" ]]; then
    ...
    awk '!seen[$0] {print} {++seen[$0]}' snplist_haps.txt > snplist_haps.tmp &&
    mv snplist_round.tmp snplist_haps.txt &&
    rm snplist_round.txt
    if [[ "$lib_type" =~ "RRS" ]] || [[ "$lib_type" =~ "rrs" ]]; then
      if [[ ! -z "$RE1" ]]; then
        mkdir -p seq_context_${RE1}
        for i in $(ls *fastq.gz); do
          $samtools view ../../preprocess/${i%.f*}_TF_precall.bam | awk '{print $3"\t"$4"\t"$10}' | awk -v seq="^${RE1}" '$3 ~ seq' | awk '{$2=sprintf("%d00",$2/100)}1' | \
          awk '{$1":"$2"\t"$3}' | awk 'NR==FNR {a[$1]++; next} $1 in a' snplist_haps.txt - > ./seq_context_${RE1}/${i%.f*}_seqcontext.txt
        done
      fi
      if [[ ! -z "$RE2" ]]; then
        mkdir -p seq_context_${RE2}
        for i in $(ls *fastq.gz); do
          $samtools view ../../preprocess/${i%.f*}_TF_precall.bam | awk '{print $3"\t"$4"\t"$10}' | awk -v seq="^${RE2}" '$3 ~ seq' | awk '{$2=sprintf("%d00",$2/100)}1' | \
          awk '{$1":"$2"\t"$3}' | awk 'NR==FNR {a[$1]++; next} $1 in a' snplist_haps.txt - > ./seq_context_${RE2}/${i%.f*}_seqcontext.txt
        done
      fi
    fi
