...
for i in $(ls -S *.f* | grep -v R2.f); do (
  ...
  awk '{print "seq"NR"_"$0}' ../preprocess/${i%.f*}_exp.sam | awk '{gsub(/ /,"\t"); print}' | awk '{$11 = $10; print}' | awk 'BEGIN{OFS="\t"}{gsub(/A|a|C|c|G|g|T|t|N|n/,"I",$11); print}' > ../preprocess/${i%.f*}_exp1.sam
		...
		cat ../preprocess/${i%.f*}_heading.sam ../preprocess/${i%.f*}_exp2.sam > ../preprocess/${i%.f*}_${ref4%.f*}.sam
		rm ../preprocess/${i%.f*}_exp*
  ...
  awk '{print "seq"NR"_"$0}' ../preprocess/${i%.f*}_exp.sam | awk '{gsub(/ /,"\t"); print}' | awk '{$11 = $10; print}' | awk 'BEGIN{OFS="\t"}{gsub(/A|a|C|c|G|g|T|t|N|n/,"I",$11); print}' > ../preprocess/${i%.f*}_exp1.sam
		...
		cat ../preprocess/${i%.f*}_heading.sam ../preprocess/${i%.f*}_exp2.sam > ../preprocess/${i%.f*}_${ref1%.f*}_${ref4%.f*}.sam
		rm ../preprocess/${i%.f*}_exp*
  ...
  awk '{print "seq"NR"_"$0}' ../preprocess/${i%.f*}_exp.sam | awk '{gsub(/ /,"\t"); print}' | awk '{$11 = $10; print}' | awk 'BEGIN{OFS="\t"}{gsub(/A|a|C|c|G|g|T|t|N|n/,"I",$11); print}' > ../preprocess/${i%.f*}_exp1.sam
		...
		cat ../preprocess/${i%.f*}_heading.sam ../preprocess/${i%.f*}_exp2.sam > ../preprocess/${i%.f*}_${ref2%.f*}_${ref4%.f*}.sam
		rm ../preprocess/${i%.f*}_exp*
  ...
  awk '{print "seq"NR"_"$0}' ../preprocess/${i%.f*}_exp.sam | awk '{gsub(/ /,"\t"); print}' | awk '{$11 = $10; print}' | awk 'BEGIN{OFS="\t"}{gsub(/A|a|C|c|G|g|T|t|N|n/,"I",$11); print}' > ../preprocess/${i%.f*}_exp1.sam
		...
		cat ../preprocess/${i%.f*}_heading.sam ../preprocess/${i%.f*}_exp2.sam > ../preprocess/${i%.f*}_${ref3%.f*}_${ref4%.f*}.sam
		rm ../preprocess/${i%.f*}_exp*
  ...
  awk '{print "seq"NR"_"$0}' ../preprocess/${i%.f*}_exp.sam | awk '{gsub(/ /,"\t"); print}' | awk '{$11 = $10; print}' | awk 'BEGIN{OFS="\t"}{gsub(/A|a|C|c|G|g|T|t|N|n/,"I",$11); print}' > ../preprocess/${i%.f*}_exp1.sam
		...
		cat ../preprocess/${i%.f*}_heading.sam ../preprocess/${i%.f*}_exp2.sam > ../preprocess/${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}.sam
		rm ../preprocess/${i%.f*}_exp*
  ...
  awk '{print "seq"NR"_"$0}' ../preprocess/${i%.f*}_exp.sam | awk '{gsub(/ /,"\t"); print}' | awk '{$11 = $10; print}' | awk 'BEGIN{OFS="\t"}{gsub(/A|a|C|c|G|g|T|t|N|n/,"I",$11); print}' > ../preprocess/${i%.f*}_exp1.sam
		...
		cat ../preprocess/${i%.f*}_heading.sam ../preprocess/${i%.f*}_exp2.sam > ../preprocess/${i%.f*}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}.sam
		rm ../preprocess/${i%.f*}_exp*
  ...
  awk '{print "seq"NR"_"$0}' ../preprocess/${i%.f*}_exp.sam | awk '{gsub(/ /,"\t"); print}' | awk '{$11 = $10; print}' | awk 'BEGIN{OFS="\t"}{gsub(/A|a|C|c|G|g|T|t|N|n/,"I",$11); print}' > ../preprocess/${i%.f*}_exp1.sam
		...
		cat ../preprocess/${i%.f*}_heading.sam ../preprocess/${i%.f*}_exp2.sam > ../preprocess/${i%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam
		rm ../preprocess/${i%.f*}_exp*
  ...
  awk '{print "seq"NR"_"$0}' ../preprocess/${i%.f*}_exp.sam | awk '{gsub(/ /,"\t"); print}' | awk '{$11 = $10; print}' | awk 'BEGIN{OFS="\t"}{gsub(/A|a|C|c|G|g|T|t|N|n/,"I",$11); print}' > ../preprocess/${i%.f*}_exp1.sam
		...
		cat ../preprocess/${i%.f*}_heading.sam ../preprocess/${i%.f*}_exp2.sam > ../preprocess/${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam
		rm ../preprocess/${i%.f*}_exp*
...
if [ "$ncohorts" == 1 ]; then
	...
	if [[ "$(wc -l ../refgenomes/panref.dict | awk '{print $1}')" -le $cthreads ]]; then
		for selchr in $Get_Chromosome; do (
			$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -L $selchr $input -ploidy $ploidy -O ../snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${ploidy}x_"${selchr}"_raw.vcf.gz --max-reads-per-alignment-start "$((downsample * ploidy))"  --max-num-haplotypes-in-population "$((ploidy * maxHaplotype))" )&
		...
		$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta $input -ploidy $ploidy -O ../snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${ploidy}x_raw.vcf.gz --max-reads-per-alignment-start "$((downsample * ploidy))"  --max-num-haplotypes-in-population "$((ploidy * maxHaplotype))"
	fi
...
if [ "$ncohorts" == 1 ]; then
	...
	if [[ "$(wc -l ../refgenomes/panref.dict | awk '{print $1}')" -le $cthreads ]]; then
		for selchr in $Get_Chromosome; do (
			$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -L $selchr $input -ploidy ${calcploidy} -O ../snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_"${selchr}"_raw.vcf.gz --max-reads-per-alignment-start "$((downsample * calcploidy))" --max-num-haplotypes-in-population "$((calcploidy * maxHaplotype))" )&
			if [[ $(jobs -r -p | wc -l) -ge $gN ]]; then
				wait
			fi
		done
		...
		$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta $input -ploidy ${calcploidy} -O ../snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_raw.vcf.gz --max-reads-per-alignment-start "$((downsample * calcploidy))" --max-num-haplotypes-in-population "$((calcploidy * maxHaplotype))"
	fi
	cd ${projdir}/preprocess
...
if [ "$ncohorts" == 1 ]; then
	...
	if [[ "$(wc -l ../refgenomes/panref.dict | awk '{print $1}')" -le $cthreads ]]; then
		for selchr in $Get_Chromosome; do (
			$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -L $selchr $input -ploidy ${calcploidy} -O ../snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_"${selchr}"_raw.vcf.gz --max-reads-per-alignment-start "$((downsample * calcploidy))" --max-num-haplotypes-in-population "$((calcploidy * maxHaplotype))" )&
			if [[ $(jobs -r -p | wc -l) -ge $gN ]]; then
				wait
			fi
		done
		...
		$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta $input -ploidy ${calcploidy} -O ../snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf.gz --max-reads-per-alignment-start "$((downsample * calcploidy))" --max-num-haplotypes-in-population "$((calcploidy * maxHaplotype))"
	fi
	cd ${projdir}/preprocess
...
if [ "$ncohorts" == 1 ]; then
	...
	if [[ "$(wc -l ../refgenomes/panref.dict | awk '{print $1}')" -le $cthreads ]]; then
		for selchr in $Get_Chromosome; do (
			$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -L $selchr $input -ploidy ${calcploidy} -O ../snpcall/${pop}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_"${selchr}"_raw.vcf.gz --max-reads-per-alignment-start "$((downsample * calcploidy))" --max-num-haplotypes-in-population "$((calcploidy * maxHaplotype))" )&
			if [[ $(jobs -r -p | wc -l) -ge $gN ]]; then
				wait
			fi
		done
		...
		$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta $input -ploidy ${calcploidy} -O ../snpcall/${pop}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf.gz --max-reads-per-alignment-start "$((downsample * calcploidy))" --max-num-haplotypes-in-population "$((calcploidy * maxHaplotype))"
	fi
	cd ${projdir}/preprocess
...
if [ "$ncohorts" == 1 ]; then
	...
	if [[ "$(wc -l ../refgenomes/panref.dict | awk '{print $1}')" -le $cthreads ]]; then
		for selchr in $Get_Chromosome; do (
			$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -L $selchr $input -ploidy ${calcploidy} -O ../snpcall/${pop}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_"${selchr}"_raw.vcf.gz --max-reads-per-alignment-start "$((downsample * calcploidy))" --max-num-haplotypes-in-population "$((calcploidy * maxHaplotype))" )&
			if [[ $(jobs -r -p | wc -l) -ge $gN ]]; then
				wait
			fi
		done
		...
		$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta $input -ploidy ${calcploidy} -O ../snpcall/${pop}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf.gz --max-reads-per-alignment-start "$((downsample * calcploidy))" --max-num-haplotypes-in-population "$((calcploidy * maxHaplotype))"
	fi
	cd ${projdir}/preprocess
...
if [ "$ncohorts" == 1 ]; then
	...
	if [[ "$(wc -l ../refgenomes/panref.dict | awk '{print $1}')" -le $cthreads ]]; then
		for selchr in $Get_Chromosome; do (
			$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -L $selchr $input -ploidy ${calcploidy} -O ../snpcall/${pop}_${ref1%.f*}_${ref4%.f*}_${calcploidy}x_"${selchr}"_raw.vcf.gz --max-reads-per-alignment-start "$((downsample * calcploidy))" --max-num-haplotypes-in-population "$((calcploidy * maxHaplotype))" )&
			if [[ $(jobs -r -p | wc -l) -ge $gN ]]; then
				wait
			fi
		done
		...
		$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta $input -ploidy ${calcploidy} -O ../snpcall/${pop}_${ref1%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf.gz --max-reads-per-alignment-start "$((downsample * calcploidy))" --max-num-haplotypes-in-population "$((calcploidy * maxHaplotype))"
	fi
	cd ${projdir}/preprocess
...
if [ "$ncohorts" == 1 ]; then
	...
	if [[ "$(wc -l ../refgenomes/panref.dict | awk '{print $1}')" -le $cthreads ]]; then
		for selchr in $Get_Chromosome; do (
			$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -L $selchr $input -ploidy ${calcploidy} -O ../snpcall/${pop}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_"${selchr}"_raw.vcf.gz --max-reads-per-alignment-start "$((downsample * calcploidy))" --max-num-haplotypes-in-population "$((calcploidy * maxHaplotype))" )&
			if [[ $(jobs -r -p | wc -l) -ge $gN ]]; then
				wait
			fi
		done
		...
		$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta $input -ploidy ${calcploidy} -O ../snpcall/${pop}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf.gz --max-reads-per-alignment-start "$((downsample * calcploidy))" --max-num-haplotypes-in-population "$((calcploidy * maxHaplotype))"
	fi
	cd ${projdir}/preprocess
...
if [ "$ncohorts" == 1 ]; then
	...
	if [[ "$(wc -l ../refgenomes/panref.dict | awk '{print $1}')" -le $cthreads ]]; then
		for selchr in $Get_Chromosome; do (
			$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -L $selchr $input -ploidy ${calcploidy} -O ../snpcall/${pop}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_"${selchr}"_raw.vcf.gz --max-reads-per-alignment-start "$((downsample * calcploidy))" --max-num-haplotypes-in-population "$((calcploidy * maxHaplotype))" )&
			if [[ $(jobs -r -p | wc -l) -ge $gN ]]; then
				wait
			fi
		done
		...
		$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta $input -ploidy ${calcploidy} -O ../snpcall/${pop}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf.gz --max-reads-per-alignment-start "$((downsample * calcploidy))" --max-num-haplotypes-in-population "$((calcploidy * maxHaplotype))"
	fi
	cd ${projdir}/preprocess
...
if [ "$ncohorts" == 1 ]; then
	...
	if [[ "$(wc -l ../refgenomes/panref.dict | awk '{print $1}')" -le $cthreads ]]; then
		for selchr in $Get_Chromosome; do (
			$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -L $selchr $input -ploidy ${ploidy_ref4} -O ../snpcall/${pop}_${ref4%.f*}_${ploidy_ref4}x_"${selchr}"_raw.vcf.gz --max-reads-per-alignment-start "$((downsample * ploidy_ref4))" --max-num-haplotypes-in-population "$((ploidy_ref4 * maxHaplotype))" )&
			if [[ $(jobs -r -p | wc -l) -ge $gN ]]; then
				wait
			fi
		done
		...
		$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta $input -ploidy ${ploidy_ref4} -O ../snpcall/${pop}_${ref4%.f*}_${ploidy_ref4}x_raw.vcf.gz --max-reads-per-alignment-start "$((downsample * ploidy_ref4))" --max-num-haplotypes-in-population "$((ploidy_ref4 * maxHaplotype))"
	fi
	cd ${projdir}/preprocess
...
if [ "$ncohorts" != 1 ]; then
	...
	for i in $(ls -S *_${ref4%.f*}_precall.bam); do (
		$GATK --java-options "$Xmx3 -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ../refgenomes/panref.fasta -L ../refgenomes/intervals.list -I $i -ploidy ${ploidy_ref4} -O ../snpcall/${i%_precall.bam}.g.vcf.gz -ERC GVCF --max-reads-per-alignment-start "$((downsample * ploidy_ref4))" --max-num-haplotypes-in-population "$((paralogs * ploidy_ref4))"
		cp ../snpcall/${i%_precall.bam}.g.vcf.gz* ../snpcall/processed/ ) &
		if [[ $(jobs -r -p | wc -l) -ge $gN ]]; then
			wait
		fi
