...
main () {
		...
		if [[ "$lib_type" == "RRS" ]] && test ! -f ${projdir}/compress_done.txt && test ! -f ${projdir}/organize_files_done.txt && test ! -f ${projdir}/preprocess/${i%.f*}_redun.sam && test ! -f ${projdir}/preprocess/${i%.f*}_${ref1%.f*}_precall.bam.bai; then
			if test ! -f ${i%.f*}_uniq_R1.fasta.gz; then
				...
				if test -f "${i%.f*}_R2_uniq.txt.gz"; then
					...
					wait
					awk 'NF==3 {print ">seq"NR"_pe-"$0}' <(zcat ${i%.f*}_rdrefseq.txt.gz 2> /dev/null) | awk '{print $1"\t"$2}' | $gzip | cat - <( 2> /dev/null ${i%.f*}_rdrefseq_se.txt.gz 2> /dev/null) > ${i%.f*}_uniq_R1.hold.fasta.gz 2> /dev/null &&
					wait
				...
				if [[ "$lib_type" == "RRS" ]] && test ! -f ${projdir}/compress_done.txt && test ! -f ${projdir}/organize_files_done.txt && test ! -f ${projdir}/preprocess/${i%.f*}_redun.sam && test ! -f ${projdir}/preprocess/${i%.f*}_${ref1%.f*}_precall.bam.bai; then
					if test ! -f ${i%.f*}_uniq_R1.fasta.gz; then
						...
						if test -f "${i%.f*}_R2_uniq.txt.gz"; then
							...
							awk 'NF==3 {print ">seq"NR"_pe-"$0}' <(zcat ${i%.f*}_rdrefseq.txt.gz 2> /dev/null) | awk '{print $1"\t"$3}' | $gzip > ${i%.f*}_uniq_R2.fasta.gz 2> /dev/null &&
							wait
							awk 'NF==3 {print ">seq"NR"_pe-"$0}' <(zcat ${i%.f*}_rdrefseq.txt.gz 2> /dev/null) | awk '{print $1"\t"$2}' | $gzip | cat - <(zcat ${i%.f*}_rdrefseq_se.txt.gz 2> /dev/null) > ${i%.f*}_uniq_R1.hold.fasta.gz 2> /dev/null &&
							wait
							rm ${i%.f*}*.txt* 2> /dev/null &&
							wait
							find . -size 0 -delete  2> /dev/null &&
	...
	if [[ "$samples_list" == "samples_list_node_1.txt" ]] && [[ "$mhap_freq" -gt 0 ]] && [[ ! -f "${projdir}/alignment_summaries/background_mutation_test/pop_haps_freqFail.txt" ]]; then
		...
		for i in $( cat ${projdir}/${samples_list} ); do
			zcat ${projdir}/samples/${i%.f*}_uniq_R1.fasta.gz 2> /dev/null | awk -F "\t" 'BEGIN { OFS=FS }; { print $1, substr($2, 1, 64); }' | awk '{a[$2]++} END{for(s in a){print a[s]" "s}}' | \
			awk -F '\t' '{gsub(/ /,"\t"); print}' | awk -F '\t' 'BEGIN{OFS="\t"} NR==FNR{a[$2]=$0;next} ($2) in a{print $0, a[$2]}' - <(zcat ${projdir}/samples/${i%.f*}_uniq_R1.fasta.gz 2> /dev/null) | \
		...
		if [[ $align == $nodes ]] && test ! -f ${projdir}/alignment_summaries/background_mutation_test/pop_haps_freqFail.txt; then
			...
			zcat pop_haps.txt.gz 2> /dev/null | awk '{a[$2]++} END{for(s in a){print a[s]" "s}}' | awk -v phap=$mhap_freq '($1 <= phap)' | awk -F '\t' '{gsub(/ /,"\t"); print}' | \
			awk -F '\t' 'BEGIN{OFS="\t"} NR==FNR{a[$2]=$0;next} ($2) in a{print $0, a[$2]}' - <(zcat pop_haps.txt.gz 2> /dev/null) | \
				...
				export nempty=$( ls ${projdir}/samples/${i%.f*}_uniq_R2.fasta.gz 2> /dev/null | wc -l | awk '{print $1}' )
				 if [[ "$mhap_freq" -gt 0 ]]; then
					 if [[ "$nempty" -gt 0 ]]; then
					  ...
					  grep -v -x -f - <(zcat ${projdir}/samples/${i%.f*}_uniq_R1.fasta.gz 2> /dev/null) | $gzip > ${projdir}/samples/${i%.f*}_uniq_R1_singleton.txt.gz &&
						zcat ${projdir}/samples/${i%.f*}_uniq_R1_singleton.txt.gz 2> /dev/null | awk -F '\t' '$1~/_se-/{print}' | awk '{gsub(/>/,"@"); print}' | awk '{print $1"\t"$2"\t"$2}' | awk 'BEGIN{OFS="\t"}{gsub(/A|a|C|c|G|g|T|t|N|n/,"I",$3); print}' | awk '{print $1"\n"$2"\n+\n"$3}' | $gzip > ${projdir}/samples/${i%.f*}_uniq_singleton.fq.gz &&
						zcat ${projdir}/samples/${i%.f*}_uniq_R1_singleton.txt.gz 2> /dev/null | awk -F '\t' '$1~/_pe-/{print}' | awk '{gsub(/>/,"@"); print}' | awk '{print $1"\t"$2"\t"$2}' | awk 'BEGIN{OFS="\t"}{gsub(/A|a|C|c|G|g|T|t|N|n/,"I",$3); print}' | awk '{print $1"/1\n"$2"\n+\n"$3}' | $gzip > ${projdir}/samples/${i%.f*}_uniq_R1.fq.gz &&
					 ...
					 if [[ "$nempty" -gt 0 ]]; then
						zcat ${projdir}/samples/${i%.f*}_uniq_R1.fasta.gz 2> /dev/null | awk -F '\t' '$1~/_se-/{print}' | awk '{gsub(/>/,"@"); print}' | awk '{print $1"\t"$2"\t"$2}' | awk 'BEGIN{OFS="\t"}{gsub(/A|a|C|c|G|g|T|t|N|n/,"I",$3); print}' | awk '{print $1"\n"$2"\n+\n"$3}' | $gzip > ${projdir}/samples/${i%.f*}_uniq_singleton.fq.gz &&
	...
	for i in $( cat ${projdir}/${samples_list} ); do
		if test ! -f ${projdir}/preprocess/${i%.f*}_${ref1%.f*}_precall.bam.bai && test ! -f ${projdir}/preprocess/${i%.f*}_${ref2%.f*}_precall.bam.bai && test ! -f ${projdir}/preprocess/${i%.f*}_${ref1%.f*}_${ref2%.f*}_precall.bam.bai; then
			if test ! -f ${projdir}/alignment_done.txt; then
				...
				$samtools flagstat <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) >> ${projdir}/alignment_summaries/${i%.f*}_summ.txt && \
				printf '########################################################################################################\n\n' >> ${projdir}/alignment_summaries/${i%.f*}_summ.txt && \
				printf 'copy\tFrequency\tPercentage\n' > ${projdir}/alignment_summaries/copy_number/${i%.f*}_copy_number_Unique_Read_histogram.txt && \
				grep -v '^@' <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) | awk -F' ' '{print $1}' | awk '{gsub(/_/,"\t");gsub(/\//,"\t");gsub(/pe-/,"");gsub(/se-/,""); print $2}' | \
				...
				grep -v '^@' <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) | awk '($3 != "\*")' | awk '($6 != "\*")' | awk '{print $3"\t"$3"\t"$0}' | \
        ...
        awk '{if($1==4) print $2}' ${projdir}/preprocess/${i%.f*}_Index_subgenome.txt | grep -Fw -f - <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) | cat <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null | grep '^@') - > ${projdir}/preprocess/${i%.f*}_del_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam

        awk '{if($1==3) print $0}' ${projdir}/preprocess/${i%.f*}_Index_subgenome.txt | awk -v ref1=${ref1%.f*} -v ref2=${ref2%.f*} -v ref3=${ref3%.f*} '{if($3== ref1 || $3 == ref2 || $3 == ref3) print $2}' | grep -Fw -f - <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_del0_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}.sam
				...
				cat <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null | grep '^@') - > ${projdir}/preprocess/${i%.f*}_del_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}.sam
				rm ${projdir}/preprocess/${i%.f*}_del0_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}.sam
        awk '{if($1==3) print $0}' ${projdir}/preprocess/${i%.f*}_Index_subgenome.txt | awk -v ref1=${ref1%.f*} -v ref2=${ref2%.f*} -v ref3=${ref4%.f*} '{if($3== ref1 || $3 == ref2 || $3 == ref4) print $2}' | grep -Fw -f - <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_del0_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}.sam
				...
				cat <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null | grep '^@') - > ${projdir}/preprocess/${i%.f*}_del_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}.sam
				rm ${projdir}/preprocess/${i%.f*}_del0_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}.sam
        awk '{if($1==3) print $0}' ${projdir}/preprocess/${i%.f*}_Index_subgenome.txt | awk -v ref1=${ref1%.f*} -v ref2=${ref3%.f*} -v ref3=${ref4%.f*} '{if($3== ref1 || $3 == ref3 || $3 == ref4) print $2}' | grep -Fw -f - <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_del0_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}.sam
				...
				cat <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null | grep '^@') - > ${projdir}/preprocess/${i%.f*}_del_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}.sam
				rm ${projdir}/preprocess/${i%.f*}_del0_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}.sam
        awk '{if($1==3) print $0}' ${projdir}/preprocess/${i%.f*}_Index_subgenome.txt | awk -v ref1=${ref2%.f*} -v ref2=${ref3%.f*} -v ref3=${ref4%.f*} '{if($3== ref2 || $3 == ref3 || $3 == ref4) print $2}' | grep -Fw -f - <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_del0_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam
				...
				cat <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null | grep '^@') - > ${projdir}/preprocess/${i%.f*}_del_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam
				rm ${projdir}/preprocess/${i%.f*}_del0_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam


        awk '{if($1==2) print $0}' ${projdir}/preprocess/${i%.f*}_Index_subgenome.txt | awk -v ref1=${ref1%.f*} -v ref2=${ref2%.f*} '{if($3== ref1 || $3 == ref2) print $2}' | grep -Fw -f - <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_del0_${ref1%.f*}_${ref2%.f*}.sam
				...
				cat <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null | grep '^@') - > ${projdir}/preprocess/${i%.f*}_del_${ref1%.f*}_${ref2%.f*}.sam
				rm ${projdir}/preprocess/${i%.f*}_del0_${ref1%.f*}_${ref2%.f*}.sam
        awk '{if($1==2) print $0}' ${projdir}/preprocess/${i%.f*}_Index_subgenome.txt | awk -v ref1=${ref1%.f*} -v ref3=${ref3%.f*} '{if($3== ref1 || $3 == ref3) print $2}' | grep -Fw -f - <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_del0_${ref1%.f*}_${ref3%.f*}.sam
				...
				cat <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null | grep '^@') - > ${projdir}/preprocess/${i%.f*}_del_${ref1%.f*}_${ref3%.f*}.sam
				rm ${projdir}/preprocess/${i%.f*}_del0_${ref1%.f*}_${ref3%.f*}.sam
        awk '{if($1==2) print $0}' ${projdir}/preprocess/${i%.f*}_Index_subgenome.txt | awk -v ref1=${ref1%.f*} -v ref4=${ref4%.f*} '{if($3== ref1 || $3 == ref4) print $2}' | grep -Fw -f - <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_del0_${ref1%.f*}_${ref4%.f*}.sam
				...
				cat <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null | grep '^@') - > ${projdir}/preprocess/${i%.f*}_del_${ref1%.f*}_${ref4%.f*}.sam
				rm ${projdir}/preprocess/${i%.f*}_del0_${ref1%.f*}_${ref2%.f*}.sam
        awk '{if($1==2) print $0}' ${projdir}/preprocess/${i%.f*}_Index_subgenome.txt | awk -v ref2=${ref2%.f*} -v ref3=${ref3%.f*} '{if($3== ref2 || $3 == ref3) print $2}' | grep -Fw -f - <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_del0_${ref2%.f*}_${ref3%.f*}.sam
				...
				cat <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null | grep '^@') - > ${projdir}/preprocess/${i%.f*}_del_${ref2%.f*}_${ref3%.f*}.sam
				rm ${projdir}/preprocess/${i%.f*}_del0_${ref2%.f*}_${ref3%.f*}.sam
        awk '{if($1==2) print $0}' ${projdir}/preprocess/${i%.f*}_Index_subgenome.txt | awk -v ref2=${ref2%.f*} -v ref4=${ref4%.f*} '{if($3== ref2 || $3 == ref4) print $2}' | grep -Fw -f - <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_del0_${ref2%.f*}_${ref3%.f*}.sam
				...
				cat <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null | grep '^@') - > ${projdir}/preprocess/${i%.f*}_del_${ref2%.f*}_${ref4%.f*}.sam
				rm ${projdir}/preprocess/${i%.f*}_del0_${ref2%.f*}_${ref4%.f*}.sam
        awk '{if($1==2) print $0}' ${projdir}/preprocess/${i%.f*}_Index_subgenome.txt | awk -v ref3=${ref3%.f*} -v ref4=${ref4%.f*} '{if($3== ref3 || $3 == ref4) print $2}' | grep -Fw -f - <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_del0_${ref3%.f*}_${ref4%.f*}.sam
				...
				cat <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null | grep '^@') - > ${projdir}/preprocess/${i%.f*}_del_${ref3%.f*}_${ref4%.f*}.sam
				rm ${projdir}/preprocess/${i%.f*}_del0_${ref3%.f*}_${ref4%.f*}.sam

        awk -v ref1=${ref1%.f*} '{if($1==1 && $3 == ref1) print $2}' ${projdir}/preprocess/${i%.f*}_Index_subgenome.txt | grep -Fw -f - <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null)	| cat <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null | grep '^@') - > ${projdir}/preprocess/${i%.f*}_del_${ref1%.f*}.sam
        awk -v ref2=${ref2%.f*} '{if($1==1 && $3 == ref2) print $2}' ${projdir}/preprocess/${i%.f*}_Index_subgenome.txt | grep -Fw -f - <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) | cat <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null | grep '^@') - > ${projdir}/preprocess/${i%.f*}_del_${ref2%.f*}.sam
        awk -v ref3=${ref3%.f*} '{if($1==1 && $3 == ref3) print $2}' ${projdir}/preprocess/${i%.f*}_Index_subgenome.txt | grep -Fw -f - <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) | cat <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null | grep '^@') - > ${projdir}/preprocess/${i%.f*}_del_${ref3%.f*}.sam
        awk -v ref4=${ref4%.f*} '{if($1==1 && $3 == ref4) print $2}' ${projdir}/preprocess/${i%.f*}_Index_subgenome.txt | grep -Fw -f - <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) | cat <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null | grep '^@') - > ${projdir}/preprocess/${i%.f*}_del_${ref4%.f*}.sam
        ...
        echo "nloci~POS~mapQ~CHROM~CHROM" > ${projdir}/alignment_summaries/refgenome_paralogs_${i%.f*}_${ref3%.f*}.txt
				...
				{
	        awk '/@HD/ || /@SQ/{print}' <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_heading_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam
					...
					awk '{print "seq"NR"_"$0}' ${projdir}/preprocess/${i%.f*}_exp_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam | tr -s ' ' | \
				...
				{
	        awk '/@HD/ || /@SQ/{print}' <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_heading_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}.sam
					...
					awk '{print "seq"NR"_"$0}' ${projdir}/preprocess/${i%.f*}_exp_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}.sam | tr -s ' ' | \
				...
				{
	        awk '/@HD/ || /@SQ/{print}' <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_heading_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}.sam
					...
					awk '{print "seq"NR"_"$0}' ${projdir}/preprocess/${i%.f*}_exp_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}.sam | tr -s ' ' | \
				...
				{
	        awk '/@HD/ || /@SQ/{print}' <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_heading_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}.sam
					...
					awk '{print "seq"NR"_"$0}' ${projdir}/preprocess/${i%.f*}_exp_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}.sam | tr -s ' ' | \
				...
				{
	        awk '/@HD/ || /@SQ/{print}' <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_heading_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam
					...
					awk '{print "seq"NR"_"$0}' ${projdir}/preprocess/${i%.f*}_exp_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam | tr -s ' ' | \
				...
				{
	        awk '/@HD/ || /@SQ/{print}' <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_heading_${ref1%.f*}_${ref2%.f*}.sam
	        ...
	        awk '{print "seq"NR"_"$0}' ${projdir}/preprocess/${i%.f*}_exp_${ref1%.f*}_${ref2%.f*}.sam | tr -s ' ' | \
	        ...
	        rm ${projdir}/preprocess/${i%.f*}_exp_${ref1%.f*}_${ref2%.f*}.sam ${projdir}/preprocess/${i%.f*}_uniq_${ref1%.f*}_${ref2%.f*}.sam ${projdir}/preprocess/${i%.f*}_heading_${ref1%.f*}_${ref2%.f*}.sam ${projdir}/preprocess/${i%.f*}_del_${ref1%.f*}_${ref2%.f*}.sam
				...
				{
	        awk '/@HD/ || /@SQ/{print}' <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_heading_${ref1%.f*}_${ref3%.f*}.sam
	        ...
	        awk '{print "seq"NR"_"$0}' ${projdir}/preprocess/${i%.f*}_exp_${ref1%.f*}_${ref3%.f*}.sam | tr -s ' ' | \
	        ...
	        rm ${projdir}/preprocess/${i%.f*}_exp_${ref1%.f*}_${ref3%.f*}.sam ${projdir}/preprocess/${i%.f*}_uniq_${ref1%.f*}_${ref3%.f*}.sam ${projdir}/preprocess/${i%.f*}_heading_${ref1%.f*}_${ref3%.f*}.sam ${projdir}/preprocess/${i%.f*}_del_${ref1%.f*}_${ref3%.f*}.sam
				...
				{
	        awk '/@HD/ || /@SQ/{print}' <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_heading_${ref1%.f*}_${ref4%.f*}.sam
	        ...
	        awk '{print "seq"NR"_"$0}' ${projdir}/preprocess/${i%.f*}_exp_${ref1%.f*}_${ref4%.f*}.sam | tr -s ' ' | \
	        ...
	        rm ${projdir}/preprocess/${i%.f*}_exp_${ref1%.f*}_${ref4%.f*}.sam ${projdir}/preprocess/${i%.f*}_uniq_${ref1%.f*}_${ref4%.f*}.sam ${projdir}/preprocess/${i%.f*}_heading_${ref1%.f*}_${ref4%.f*}.sam ${projdir}/preprocess/${i%.f*}_del_${ref1%.f*}_${ref4%.f*}.sam
				...
				{
	        awk '/@HD/ || /@SQ/{print}' <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_heading_${ref2%.f*}_${ref3%.f*}.sam
	        ...
	        awk '{print "seq"NR"_"$0}' ${projdir}/preprocess/${i%.f*}_exp_${ref2%.f*}_${ref3%.f*}.sam | tr -s ' ' | \
	        ...
	        rm ${projdir}/preprocess/${i%.f*}_exp_${ref2%.f*}_${ref3%.f*}.sam ${projdir}/preprocess/${i%.f*}_uniq_${ref2%.f*}_${ref3%.f*}.sam ${projdir}/preprocess/${i%.f*}_heading_${ref2%.f*}_${ref3%.f*}.sam ${projdir}/preprocess/${i%.f*}_del_${ref2%.f*}_${ref3%.f*}.sam
				...
				{
	        awk '/@HD/ || /@SQ/{print}' <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_heading_${ref2%.f*}_${ref4%.f*}.sam
	        ...
	        awk '{print "seq"NR"_"$0}' ${projdir}/preprocess/${i%.f*}_exp_${ref2%.f*}_${ref4%.f*}.sam | tr -s ' ' | \
	        ...
	        rm ${projdir}/preprocess/${i%.f*}_exp_${ref2%.f*}_${ref4%.f*}.sam ${projdir}/preprocess/${i%.f*}_uniq_${ref2%.f*}_${ref4%.f*}.sam ${projdir}/preprocess/${i%.f*}_heading_${ref2%.f*}_${ref4%.f*}.sam ${projdir}/preprocess/${i%.f*}_del_${ref2%.f*}_${ref4%.f*}.sam
				...
				{
	        awk '/@HD/ || /@SQ/{print}' <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_heading_${ref3%.f*}_${ref4%.f*}.sam
	        ...
	        awk '{print "seq"NR"_"$0}' ${projdir}/preprocess/${i%.f*}_exp_${ref3%.f*}_${ref4%.f*}.sam | tr -s ' ' | \
	        ...
	        rm ${projdir}/preprocess/${i%.f*}_exp_${ref3%.f*}_${ref4%.f*}.sam ${projdir}/preprocess/${i%.f*}_uniq_${ref3%.f*}_${ref4%.f*}.sam ${projdir}/preprocess/${i%.f*}_heading_${ref3%.f*}_${ref4%.f*}.sam ${projdir}/preprocess/${i%.f*}_del_${ref3%.f*}_${ref4%.f*}.sam
				...
				{
					awk '/@HD/ || /@SQ/{print}' <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_heading_${ref1%.f*}.sam
					...
					awk '{print "seq"NR"_"$0}' ${projdir}/preprocess/${i%.f*}_exp_${ref1%.f*}.sam | tr -s ' ' | \
				...
				{
					awk '/@HD/ || /@SQ/{print}' <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_heading_${ref2%.f*}.sam
					...
					awk '{print "seq"NR"_"$0}' ${projdir}/preprocess/${i%.f*}_exp_${ref2%.f*}.sam | tr -s ' ' | \
				...
				{
	        awk '/@HD/ || /@SQ/{print}' <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_heading_${ref3%.f*}.sam
					...
					awk '{print "seq"NR"_"$0}' ${projdir}/preprocess/${i%.f*}_exp_${ref3%.f*}.sam | tr -s ' ' | \
				...
				{
					awk '/@HD/ || /@SQ/{print}' <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_heading_${ref4%.f*}.sam
					...
					awk '{print "seq"NR"_"$0}' ${projdir}/preprocess/${i%.f*}_exp_${ref4%.f*}.sam | tr -s ' ' | \
    ...
    if [[ -z "$Get_Chromosome" ]]; then
    	for selchr in $Get2_Chromosome; do (
    		if test ! -f ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.vcf; then
    			$GATK --java-options "$Xmxg -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${selchr} ${input} -ploidy ${calcploidy} -O ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    	...
    	echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2}' > ${projdir}/refgenomes/panref.list
    	$GATK --java-options "$Xmx2 -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${projdir}/refgenomes/panref.list ${input}-ploidy $calcploidy -O ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_raw.vcf.gz --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    	cd ../snpcall
    ...
    if [[ -z "$Get_Chromosome" ]]; then
    	for selchr in $Get2_Chromosome; do (
    		if test ! -f ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.vcf; then
    			$GATK --java-options "$Xmxg -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${selchr} ${input} -ploidy ${calcploidy} -O ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    	...
    	echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2}' > ${projdir}/refgenomes/panref.list
    	$GATK --java-options "$Xmx2 -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${projdir}/refgenomes/panref.list ${input}-ploidy $calcploidy -O ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf.gz --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    	cd ../snpcall
    ...
    if [[ -z "$Get_Chromosome" ]]; then
    	for selchr in $Get2_Chromosome; do (
    		if test ! -f ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.vcf; then
    			$GATK --java-options "$Xmxg -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${selchr} ${input} -ploidy ${calcploidy} -O ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    	...
    	echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2}' > ${projdir}/refgenomes/panref.list
    	$GATK --java-options "$Xmx2 -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${projdir}/refgenomes/panref.list ${input}-ploidy $calcploidy -O ${projdir}/snpcall/${pop}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf.gz --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    	cd ../snpcall
    ...
    if [[ -z "$Get_Chromosome" ]]; then
    	for selchr in $Get2_Chromosome; do (
    		if test ! -f ${projdir}/snpcall/${pop}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.vcf; then
    			$GATK --java-options "$Xmxg -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${selchr} ${input} -ploidy ${calcploidy} -O ${projdir}/snpcall/${pop}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    	...
    	echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2}' > ${projdir}/refgenomes/panref.list
    	$GATK --java-options "$Xmx2 -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${projdir}/refgenomes/panref.list ${input}-ploidy $calcploidy -O ${projdir}/snpcall/${pop}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf.gz --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    	cd ../snpcall
    ...
    if [[ -z "$Get_Chromosome" ]]; then
    	for selchr in $Get2_Chromosome; do (
    		if test ! -f ${projdir}/snpcall/${pop}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.vcf; then
    			$GATK --java-options "$Xmxg -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${selchr} ${input} -ploidy ${calcploidy} -O ${projdir}/snpcall/${pop}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    	...
    	echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2}' > ${projdir}/refgenomes/panref.list
    	$GATK --java-options "$Xmx2 -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${projdir}/refgenomes/panref.list ${input}-ploidy $calcploidy -O ${projdir}/snpcall/${pop}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf.gz --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    	cd ../snpcall
    ...
    if [[ -z "$Get_Chromosome" ]]; then
    	for selchr in $Get2_Chromosome; do (
    		if test ! -f ${projdir}/snpcall/${pop}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.vcf; then
    			$GATK --java-options "$Xmxg -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${selchr} ${input} -ploidy ${calcploidy} -O ${projdir}/snpcall/${pop}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_${selchr}_raw.vcf.gz --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    	...
    	echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2}' > ${projdir}/refgenomes/panref.list
    	$GATK --java-options "$Xmx2 -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${projdir}/refgenomes/panref.list ${input}-ploidy $calcploidy -O ${projdir}/snpcall/${pop}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf.gz --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    	cd ../snpcall
    ...
    ######################
	  ...
	  if [[ -z "$Get_Chromosome" ]]; then
	    for selchr in $Get2_Chromosome; do (
	      	...
	      	$GATK --java-options "$Xmxg -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${selchr} ${input} -ploidy $ploidy_ref4 -O ${projdir}/snpcall/${pop}_${ref4%.f*}_${ploidy_ref4}x_${selchr}_raw.vcf.gz --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((ploidy_ref4 * maxHaplotype)) &&
	    ...
	    $GATK --java-options "$Xmx2 -XX:+UseParallelGC -XX:ParallelGCThreads=$threads" HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${projdir}/refgenomes/panref.list ${input}-ploidy $ploidy -O ${projdir}/snpcall/${pop}_${ref4%.f*}_${ploidy_ref4}x_raw.vcf.gz --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((ploidy_ref4 * maxHaplotype)) &&
	    cd ../snpcall
    	...
    	if test ! -f "${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${ploidy}x_raw.vcf" && test ! -f "${projdir}/GVCF_1_2_3_4_done.txt"; then
    		if test ! -f "${projdir}/snpcall/${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.g.vcf.gz"; then
    			if [[ -z "$Get_Chromosome" ]]; then
    				...
    				echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2}' > ${projdir}/refgenomes/panref.list
    				$GATK --java-options "$Xmxg -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${projdir}/refgenomes/panref.list -I ${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_precall.bam -ploidy $ploidy -O ${projdir}/snpcall/${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((ploidy * maxHaplotype)) &&
    				wait
    			fi
    	...
    	if test ! -f "${pop}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${calcploidy}x_raw.vcf" && test ! -f "${projdir}/GVCF_1_2_3_done.txt"; then
    		if test ! -f "${projdir}/snpcall/${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}.g.vcf.gz"; then
    			if [[ -z "$Get_Chromosome" ]]; then
    				...
    				echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2}' > ${projdir}/refgenomes/panref.list
    				$GATK --java-options "$Xmxg -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${projdir}/refgenomes/panref.list -I ${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_precall.bam -ploidy $calcploidy -O ${projdir}/snpcall/${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			fi
    	...
    	if test ! -f "${pop}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf" && test ! -f "${projdir}/GVCF_1_2_4_done.txt"; then
    		if test ! -f "${projdir}/snpcall/${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}.g.vcf.gz"; then
    			if [[ -z "$Get_Chromosome" ]]; then
    				...
    				echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2}' > ${projdir}/refgenomes/panref.list
    				$GATK --java-options "$Xmxg -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${projdir}/refgenomes/panref.list -I ${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}_precall.bam -ploidy $calcploidy -O ${projdir}/snpcall/${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			fi
    	...
    	if test ! -f "${pop}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf" && test ! -f "${projdir}/GVCF_1_3_4_done.txt"; then
    		if test ! -f "${projdir}/snpcall/${i%.f*}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}.g.vcf.gz"; then
    			if [[ -z "$Get_Chromosome" ]]; then
    				...
    				echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2}' > ${projdir}/refgenomes/panref.list
    				$GATK --java-options "$Xmxg -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${projdir}/refgenomes/panref.list -I ${i%.f*}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}_precall.bam -ploidy $calcploidy -O ${projdir}/snpcall/${i%.f*}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			fi
    	...
    	if test ! -f "${pop}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf" && test ! -f "${projdir}/GVCF_2_3_4_done.txt"; then
    		if test ! -f "${projdir}/snpcall/${i%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.g.vcf.gz"; then
    			if [[ -z "$Get_Chromosome" ]]; then
    				...
    				echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2}' > ${projdir}/refgenomes/panref.list
    				$GATK --java-options "$Xmxg -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${projdir}/refgenomes/panref.list -I ${i%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}_precall.bam -ploidy $calcploidy -O ${projdir}/snpcall/${i%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			fi
    	...
    	if test ! -f "${pop}_${ref1%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf" && test ! -f "${projdir}/GVCF_1_4_done.txt"; then
    		if test ! -f "${projdir}/snpcall/${i%.f*}_${ref1%.f*}_${ref4%.f*}.g.vcf.gz"; then
    			if [[ -z "$Get_Chromosome" ]]; then
    				...
    				echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2}' > ${projdir}/refgenomes/panref.list
    				$GATK --java-options "$Xmxg -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${projdir}/refgenomes/panref.list -I ${i%.f*}_${ref1%.f*}_${ref4%.f*}_precall.bam -ploidy $calcploidy -O ${projdir}/snpcall/${i%.f*}_${ref1%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			fi
    	...
    	if test ! -f "${pop}_${ref2%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf" && test ! -f "${projdir}/GVCF_2_4_done.txt"; then
    		if test ! -f "${projdir}/snpcall/${i%.f*}_${ref2%.f*}_${ref4%.f*}.g.vcf.gz"; then
    			if [[ -z "$Get_Chromosome" ]]; then
    				...
    				echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2}' > ${projdir}/refgenomes/panref.list
    				$GATK --java-options "$Xmxg -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${projdir}/refgenomes/panref.list -I ${i%.f*}_${ref2%.f*}_${ref4%.f*}_precall.bam -ploidy $calcploidy -O ${projdir}/snpcall/${i%.f*}_${ref2%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			fi
    	...
    	if test ! -f "${pop}_${ref3%.f*}_${ref4%.f*}_${calcploidy}x_raw.vcf" && test ! -f "${projdir}/GVCF_3_4_done.txt"; then
    		if test ! -f "${projdir}/snpcall/${i%.f*}_${ref3%.f*}_${ref4%.f*}.g.vcf.gz"; then
    			if [[ -z "$Get_Chromosome" ]]; then
    				...
    				echo $Get_Chromosome | tr ',' '\n' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2}' > ${projdir}/refgenomes/panref.list
    				$GATK --java-options "$Xmxg -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads" HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${projdir}/refgenomes/panref.list -I ${i%.f*}_${ref3%.f*}_${ref4%.f*}_precall.bam -ploidy $calcploidy -O ${projdir}/snpcall/${i%.f*}_${ref3%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((calcploidy * maxHaplotype)) &&
    				wait
    			fi
  			...
  			for i in $(cat ${projdir}/${samples_list} ); do (
  				if test ! -f "${pop}_${ref4%.f*}_${ploidy_ref4}x_raw.vcf" && test ! -f "${projdir}/GVCF_4_done.txt"; then
  					if test ! -f ${projdir}/snpcall/${i%.f*}_${ref4%.f*}.g.vcf.gz; then
  						if [[ -z "$Get_Chromosome" ]]; then
  							$GATK --java-options "$Xmxg -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads"  HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -I ${i%.f*}_${ref4%.f*}_precall.bam -ploidy $ploidy_ref4 -O ${projdir}/snpcall/${i%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((ploidy_ref4 * maxHaplotype)) &&
  							wait
  						else
  						  echo $Get_Chromosome | tr ',' '\n' | awk -v pat=${ref4%.f*} '$0 ~ pat' | awk '{print "SN:"$1}' | awk 'NR==FNR{a[$1];next}$2 in a{print $0}' - ${projdir}/refgenomes/panref.dict | awk '{gsub(/SN:/,"");gsub(/LN:/,""); print $2}' > ${projdir}/refgenomes/panref.list
  							$GATK --java-options "$Xmxg -XX:+UseParallelGC -XX:ParallelGCThreads=$gthreads"  HaplotypeCaller -R ${projdir}/refgenomes/panref.fasta -L ${projdir}/refgenomes/panref.list -I ${i%.f*}_${ref4%.f*}_precall.bam -ploidy $ploidy_ref4 -O ${projdir}/snpcall/${i%.f*}_${ref4%.f*}.hold.g.vcf.gz -ERC GVCF --dont-use-soft-clipped-bases $softclip --max-reads-per-alignment-start $downsample --minimum-mapping-quality 0 --max-num-haplotypes-in-population $((ploidy_ref4 * maxHaplotype)) &&
  							wait
  						fi
...
#####################################################################################################################################################
cd ${projdir}
rm organize_files_done.txt compress_done.txt hapfilter_done.txt alignment_done.txt precall_done.txt GVCF*_done.txt samples_list_node_*.txt >/dev/null 2>&1
