	...
	for i in $( cat ${projdir}/${samples_list} ); do
        ...
        echo "nloci~POS~mapQ~CHROM~CHROM" > ${projdir}/alignment_summaries/refgenome_paralogs_${i%.f*}_${ref3%.f*}.txt
	        ...
	        awk '/@HD/ || /@SQ/{print}' <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_heading_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam
					...
					awk '($3 != "\*")' | awk '($6 != "\*")'  | awk '$5 < 10 {$5 = 20}1' | cat ${projdir}/preprocess/${i%.f*}_heading_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam - | tr ' ' '\t' > ${projdir}/preprocess/${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam
	        ...
	        awk '/@HD/ || /@SQ/{print}' <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_heading_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}.sam
					...
					awk '($3 != "\*")' | awk '($6 != "\*")'  | awk '$5 < 10 {$5 = 20}1' | cat ${projdir}/preprocess/${i%.f*}_heading_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}.sam - | tr ' ' '\t' > ${projdir}/preprocess/${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref3%.f*}.sam
	        ...
	        awk '/@HD/ || /@SQ/{print}' <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_heading_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}.sam
					...
					awk '($3 != "\*")' | awk '($6 != "\*")'  | awk '$5 < 10 {$5 = 20}1' | cat ${projdir}/preprocess/${i%.f*}_heading_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}.sam - | tr ' ' '\t' > ${projdir}/preprocess/${i%.f*}_${ref1%.f*}_${ref2%.f*}_${ref4%.f*}.sam
	        ...
	        awk '/@HD/ || /@SQ/{print}' <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_heading_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}.sam
					...
					awk '($3 != "\*")' | awk '($6 != "\*")'  | awk '$5 < 10 {$5 = 20}1' | cat ${projdir}/preprocess/${i%.f*}_heading_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}.sam - | tr ' ' '\t' > ${projdir}/preprocess/${i%.f*}_${ref1%.f*}_${ref3%.f*}_${ref4%.f*}.sam
	        ...
	        awk '/@HD/ || /@SQ/{print}' <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_heading_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam
					...
					awk '($3 != "\*")' | awk '($6 != "\*")'  | awk '$5 < 10 {$5 = 20}1' | cat ${projdir}/preprocess/${i%.f*}_heading_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam - | tr ' ' '\t' > ${projdir}/preprocess/${i%.f*}_${ref2%.f*}_${ref3%.f*}_${ref4%.f*}.sam
	        ...
	        awk '($3 != "\*")' | awk '($6 != "\*")'  | awk '$5 < 10 {$5 = 20}1' | cat ${projdir}/preprocess/${i%.f*}_heading_${ref1%.f*}_${ref2%.f*}.sam - | tr ' ' '\t' > ${projdir}/preprocess/${i%.f*}_${ref1%.f*}_${ref2%.f*}.sam
	        ...
	        awk '($3 != "\*")' | awk '($6 != "\*")'  | awk '$5 < 10 {$5 = 20}1' | cat ${projdir}/preprocess/${i%.f*}_heading_${ref1%.f*}_${ref3%.f*}.sam - | tr ' ' '\t' > ${projdir}/preprocess/${i%.f*}_${ref1%.f*}_${ref3%.f*}.sam
	        ...
	        awk '($3 != "\*")' | awk '($6 != "\*")'  | awk '$5 < 10 {$5 = 20}1' | cat ${projdir}/preprocess/${i%.f*}_heading_${ref1%.f*}_${ref4%.f*}.sam - | tr ' ' '\t' > ${projdir}/preprocess/${i%.f*}_${ref1%.f*}_${ref4%.f*}.sam
	        ...
	        awk '($3 != "\*")' | awk '($6 != "\*")'  | awk '$5 < 10 {$5 = 20}1' | cat ${projdir}/preprocess/${i%.f*}_heading_${ref2%.f*}_${ref3%.f*}.sam - | tr ' ' '\t' > ${projdir}/preprocess/${i%.f*}_${ref2%.f*}_${ref3%.f*}.sam
	        ...
	        awk '($3 != "\*")' | awk '($6 != "\*")'  | awk '$5 < 10 {$5 = 20}1' | cat ${projdir}/preprocess/${i%.f*}_heading_${ref2%.f*}_${ref4%.f*}.sam - | tr ' ' '\t' > ${projdir}/preprocess/${i%.f*}_${ref2%.f*}_${ref4%.f*}.sam
	        ...
	        awk '($3 != "\*")' | awk '($6 != "\*")'  | awk '$5 < 10 {$5 = 20}1' | cat ${projdir}/preprocess/${i%.f*}_heading_${ref3%.f*}_${ref4%.f*}.sam - | tr ' ' '\t' > ${projdir}/preprocess/${i%.f*}_${ref3%.f*}_${ref4%.f*}.sam
	        rm ${projdir}/preprocess/${i%.f*}_exp_${ref3%.f*}_${ref4%.f*}.sam ${projdir}/preprocess/${i%.f*}_uniq_${ref3%.f*}_${ref4%.f*}.sam ${projdir}/preprocess/${i%.f*}_heading_${ref3%.f*}_${ref4%.f*}.sam ${projdir}/preprocess/${i%.f*}_del_${ref3%.f*}_${ref4%.f*}.sam
...

				{
					...
					awk '($3 != "\*")' | awk '($6 != "\*")'  | awk '$5 < 10 {$5 = 20}1' | cat ${projdir}/preprocess/${i%.f*}_heading_${ref1%.f*}.sam - | tr ' ' '\t' > ${projdir}/preprocess/${i%.f*}_${ref1%.f*}.sam
...

				{
					...
					awk '($3 != "\*")' | awk '($6 != "\*")'  | awk '$5 < 10 {$5 = 20}1' | cat ${projdir}/preprocess/${i%.f*}_heading_${ref2%.f*}.sam - | tr ' ' '\t' > ${projdir}/preprocess/${i%.f*}_${ref2%.f*}.sam
	        ...
	        awk '/@HD/ || /@SQ/{print}' <(zcat ${projdir}/preprocess/${i%.f*}_redun.sam.gz 2> /dev/null) > ${projdir}/preprocess/${i%.f*}_heading_${ref3%.f*}.sam
					...
					awk '($3 != "\*")' | awk '($6 != "\*")'  | awk '$5 < 10 {$5 = 20}1' | cat ${projdir}/preprocess/${i%.f*}_heading_${ref3%.f*}.sam - | tr ' ' '\t' > ${projdir}/preprocess/${i%.f*}_${ref3%.f*}.sam
...

				{
					...
					awk '($3 != "\*")' | awk '($6 != "\*")'  | awk '$5 < 10 {$5 = 20}1' | cat ${projdir}/preprocess/${i%.f*}_heading_${ref4%.f*}.sam - | tr ' ' '\t' > ${projdir}/preprocess/${i%.f*}_${ref4%.f*}.sam
