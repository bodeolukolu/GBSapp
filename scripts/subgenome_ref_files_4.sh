...
for i in $(ls -S *.f* | grep -v R2.f); do (
  ...
  awk '!/^@/ { print }' ../preprocess/${i%.f*}_${ref1%.f*}.sam | awk '{gsub(/^.*-/,"",$1); print $0}' | awk '{gsub(/^.*_/,"",$2); print $0}' > ../preprocess/${i%.f*}_uniq.sam
	...
	if [ "$multilocus" == "true" ]; then
		...
		grep -vwE "(@HD|@SQ|@PG)" ../preprocess/${i%.f*}_2del.sam | awk '{print $1"~"$9"~"$7"~"$8}' >> ../alignment_summaries/refgenome_paralogs_${i%.f*}_${ref1%.f*}.txt
  ...
  awk '!/^@/ { print }' ../preprocess/${i%.f*}_${ref2%.f*}.sam | awk '{gsub(/^.*-/,"",$1); print $0}' | awk '{gsub(/^.*_/,"",$2); print $0}' > ../preprocess/${i%.f*}_uniq.sam
	...
	if [ "$multilocus" == "true" ]; then
		...
		grep -vwE "(@HD|@SQ|@PG)" ../preprocess/${i%.f*}_2del.sam | awk '{print $2"~"$9"~"$7"~"$8}' >> ../alignment_summaries/refgenome_paralogs_${i%.f*}_${ref2%.f*}.txt
  ...
  awk '!/^@/ { print }' ../preprocess/${i%.f*}_${ref3%.f*}.sam | awk '{gsub(/^.*-/,"",$1); print $0}' | awk '{gsub(/^.*_/,"",$2); print $0}' > ../preprocess/${i%.f*}_uniq.sam
	...
	if [ "$multilocus" == "true" ]; then
		...
		grep -vwE "(@HD|@SQ|@PG)" ../preprocess/${i%.f*}_2del.sam | awk '{print $3"~"$9"~"$7"~"$8}' >> ../alignment_summaries/refgenome_paralogs_${i%.f*}_${ref3%.f*}.txt
  ...
  awk '!/^@/ { print }' ../preprocess/${i%.f*}_${ref4%.f*}.sam | awk '{gsub(/^.*-/,"",$1); print $0}' | awk '{gsub(/^.*_/,"",$2); print $0}' > ../preprocess/${i%.f*}_uniq.sam
	...
	if [ "$multilocus" == "true" ]; then
		echo "nloci~mapQ~CHROM~POS" > ../alignment_summaries/refgenome_paralogs_${i%.f*}_${ref4%.f*}.txt
		grep -vwE "(@HD|@SQ|@PG)" ../preprocess/${i%.f*}_2del.sam | awk '{print $4"~"$9"~"$7"~"$8}' >> ../alignment_summaries/refgenome_paralogs_${i%.f*}_${ref4%.f*}.txt
		awk '!visited[$0]++' ../alignment_summaries/refgenome_paralogs_${i%.f*}_${ref4%.f*}.txt > ../alignment_summaries/temp_${i%.f*}.txt
		mv ../alignment_summaries/temp_${i%.f*}.txt ../alignment_summaries/refgenome_paralogs_${i%.f*}_${ref4%.f*}.txt
	fi
